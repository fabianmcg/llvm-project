...
#ifndef MLIR_TABLEGEN_CPPGEN_ATTRORTYPEFORMATGEN_H
#define MLIR_TABLEGEN_CPPGEN_ATTRORTYPEFORMATGEN_H
...
protected:
  ...
  void genLiteralPrinter(llvm::StringRef value, FmtContext &ctx, MethodBody &os);
...
protected:
  ...
  LogicalResult verifyStructArguments(SMLoc loc,
                                      llvm::ArrayRef<FormatElement *> arguments);
...
/// attribute or type. If \p fatalOnError is true, a parse failure is a fatal
...
#endif // MLIR_TABLEGEN_CPPGEN_ATTRORTYPEFORMATGEN_H
