...
#ifndef MLIR_TABLEGEN_CPPGEN_PASSDOCGEN_H
#define MLIR_TABLEGEN_CPPGEN_PASSDOCGEN_H
...
/// Emit documentation for all passes derived from PassBase in \p records.
void emitPassDocs(const llvm::RecordKeeper &records, llvm::raw_ostream &os);

} // namespace tblgen
} // namespace mlir

#endif // MLIR_TABLEGEN_CPPGEN_PASSDOCGEN_H
