...
#ifndef MLIR_TABLEGEN_CPPGEN_CPPGENUTILITIES_H
#define MLIR_TABLEGEN_CPPGEN_CPPGENUTILITIES_H
...
/// Emit the summary and description as a C++ comment. If \p terminateComment
...
#endif // MLIR_TABLEGEN_CPPGEN_CPPGENUTILITIES_H
