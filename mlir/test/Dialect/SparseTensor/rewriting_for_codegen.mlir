...
// CHECK-SAME:    %[[A:.*]]: !ptr.ptr) -> tensor<?x?xf32, #sparse{{[0-9]*}}> {
// CHECK:         %[[COO:.*]] = sparse_tensor.new %[[A]] : !ptr.ptr to tensor<?x?xf32, #sparse{{[0-9]*}}>
// CHECK:         %[[R:.*]] = sparse_tensor.convert %[[COO]]
// CHECK:         bufferization.dealloc_tensor %[[COO]]
// CHECK:         return %[[R]]
func.func @sparse_new(%arg0: !ptr.ptr) -> tensor<?x?xf32, #CSR> {
...
// CHECK:         bufferization.dealloc_tensor %[[COO]]
// CHECK:         return %[[R]]
func.func @sparse_new_csc(%arg0: !ptr.ptr) -> tensor<?x?xf32, #CSC> {
  %0 = sparse_tensor.new %arg0 : !ptr.ptr to tensor<?x?xf32, #CSC>
...
// CHECK:         return
// CHECK:         }
func.func @sparse_out( %arg0: tensor<10x20xf32, #CSR>, %arg1: !ptr.ptr) -> () {
  sparse_tensor.out %arg0, %arg1 : tensor<10x20xf32, #CSR>, !ptr.ptr
  return
}
