...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr) -> !ptr.ptr
//       CHECK: return %[[A]] : !ptr.ptr
func.func @sparse_nop(%arg0: tensor<?xf64, #SparseVector>) -> tensor<?xf64, #SparseVector> {
  return %arg0 : tensor<?xf64, #SparseVector>
}

// CHECK-LABEL: func @sparse_dim1d(
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
...
//       CHECK: return %[[T]] : !ptr.ptr
func.func @sparse_new1d(%arg0: !ptr.ptr) -> tensor<128xf64, #SparseVector> {
  %0 = sparse_tensor.new %arg0 : !ptr.ptr to tensor<128xf64, #SparseVector>
...
//       CHECK: call @delSparseTensorReader(%[[Reader]])
//       CHECK: return %[[T]] : !ptr.ptr
func.func @sparse_new2d(%arg0: !ptr.ptr) -> tensor<?x?xf32, #CSR> {
  %0 = sparse_tensor.new %arg0 : !ptr.ptr to tensor<?x?xf32, #CSR>
...
//       CHECK: call @delSparseTensorReader(%[[Reader]])
//       CHECK: return %[[T]] : !ptr.ptr
func.func @sparse_new3d(%arg0: !ptr.ptr) -> tensor<?x?x?xf32, #SparseTensor> {
  %0 = sparse_tensor.new %arg0 : !ptr.ptr to tensor<?x?x?xf32, #SparseTensor>
  return %0 : tensor<?x?x?xf32, #SparseTensor>
}

// CHECK-LABEL: func @sparse_init(
//  CHECK-SAME: %[[I:.*]]: index,
//  CHECK-SAME: %[[J:.*]]: index) -> !ptr.ptr
...
//       CHECK: %[[NP:.*]] = llvm.mlir.zero : !ptr.ptr
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
//       CHECK: call @delSparseTensor(%[[A]]) : (!ptr.ptr) -> ()
//       CHECK: return
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
//       CHECK: %[[C:.*]] = arith.constant 0 : index
//       CHECK: %[[T:.*]] = call @sparsePositions0(%[[A]], %[[C]]) : (!ptr.ptr, index) -> memref<?xindex>
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
//       CHECK: %[[C:.*]] = arith.constant 0 : index
//       CHECK: %[[T:.*]] = call @sparsePositions64(%[[A]], %[[C]]) : (!ptr.ptr, index) -> memref<?xi64>
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
//       CHECK: %[[C:.*]] = arith.constant 0 : index
//       CHECK: %[[T:.*]] = call @sparsePositions32(%[[A]], %[[C]]) : (!ptr.ptr, index) -> memref<?xi32>
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
//       CHECK: %[[C:.*]] = arith.constant 0 : index
//       CHECK: %[[T:.*]] = call @sparseCoordinates0(%[[A]], %[[C]]) : (!ptr.ptr, index) -> memref<?xindex>
//       CHECK: return %[[T]] : memref<?xindex>
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
//       CHECK: %[[C:.*]] = arith.constant 0 : index
//       CHECK: %[[T:.*]] = call @sparseCoordinates64(%[[A]], %[[C]]) : (!ptr.ptr, index) -> memref<?xi64>
//       CHECK: return %[[T]] : memref<?xi64>
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
//       CHECK: %[[C:.*]] = arith.constant 0 : index
//       CHECK: %[[T:.*]] = call @sparseCoordinates32(%[[A]], %[[C]]) : (!ptr.ptr, index) -> memref<?xi32>
//       CHECK: return %[[T]] : memref<?xi32>
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
//       CHECK: %[[T:.*]] = call @sparseValuesF64(%[[A]]) : (!ptr.ptr) -> memref<?xf64>
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
//       CHECK: %[[T:.*]] = call @sparseValuesF32(%[[A]]) : (!ptr.ptr) -> memref<?xf32>
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
//       CHECK: %[[T:.*]] = call @sparseValuesI32(%[[A]]) : (!ptr.ptr) -> memref<?xi32>
//       CHECK: return %[[T]] : memref<?xi32>
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
//       CHECK: %[[T:.*]] = call @sparseValuesI16(%[[A]]) : (!ptr.ptr) -> memref<?xi16>
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr)
//       CHECK: %[[T:.*]] = call @sparseValuesI8(%[[A]]) : (!ptr.ptr) -> memref<?xi8>
...
//   CHECK-DAG: %[[T:.*]] = call @sparseValuesF64(%[[A]]) : (!ptr.ptr) -> memref<?xf64>
...
//  CHECK-SAME: %[[A:.*]]: !ptr.ptr
//       CHECK: call @endLexInsert(%[[A]]) : (!ptr.ptr) -> ()
//       CHECK: return %[[A]] : !ptr.ptr
...
//       CHECK: call @lexInsertF32(%[[A]], %[[MC]], %[[V]]) : (!ptr.ptr, memref<?xindex>, memref<f32>) -> ()
//       CHECK: return %[[A]] : !ptr.ptr
...
//       CHECK: return %[[S]], %[[D]] : !ptr.ptr, tensor<?x?xf64>
