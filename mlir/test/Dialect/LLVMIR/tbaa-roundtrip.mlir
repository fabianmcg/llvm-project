...
llvm.func @tbaa1(%arg0: !ptr.ptr, %arg1: !ptr.ptr) {
  %0 = llvm.mlir.constant(1 : i8) : i8
  llvm.store %0, %arg0 {tbaa = [#tbaa_tag_0]} : i8, !ptr.ptr
  llvm.store %0, %arg1 {tbaa = [#tbaa_tag_1]} : i8, !ptr.ptr
  llvm.return
}

// CHECK:           llvm.func @tbaa1(%[[VAL_0:.*]]: !ptr.ptr, %[[VAL_1:.*]]: !ptr.ptr) {
// CHECK:             %[[VAL_2:.*]] = llvm.mlir.constant(1 : i8) : i8
// CHECK:             llvm.store %[[VAL_2]], %[[VAL_0]] {tbaa = [#[[$TAG_0]]]} : i8, !ptr.ptr
// CHECK:             llvm.store %[[VAL_2]], %[[VAL_1]] {tbaa = [#[[$TAG_1]]]} : i8, !ptr.ptr
// CHECK:             llvm.return
// CHECK:           }
...
llvm.func @tbaa2(%arg0: !ptr.ptr, %arg1: !ptr.ptr) {
  ...
  %3 = llvm.load %2 {tbaa = [#tbaa_tag_2]} : !ptr.ptr -> i64
  %4 = llvm.trunc %3 : i64 to i32
  %5 = llvm.getelementptr inbounds %arg0[%0, 0] : (!ptr.ptr, i32) -> !ptr.ptr, !llvm.struct<"struct.agg1_t", (i32, i32)>
  llvm.store %4, %5 {tbaa = [#tbaa_tag_3]} : i32, !ptr.ptr
  llvm.return
}

// CHECK:           llvm.func @tbaa2(%[[VAL_0:.*]]: !ptr.ptr, %[[VAL_1:.*]]: !ptr.ptr) {
// CHECK:             %[[VAL_2:.*]] = llvm.mlir.constant(0 : i32) : i32
// CHECK:             %[[VAL_3:.*]] = llvm.mlir.constant(1 : i32) : i32
// CHECK:             %[[VAL_4:.*]] = llvm.getelementptr inbounds %[[VAL_1]]{{\[}}%[[VAL_2]], 1] : (!ptr.ptr, i32) -> !ptr.ptr, !llvm.struct<"struct.agg2_t", (i64, i64)>
// CHECK:             %[[VAL_5:.*]] = llvm.load %[[VAL_4]] {tbaa = [#[[$TAG_2]]]} : !ptr.ptr -> i64
// CHECK:             %[[VAL_6:.*]] = llvm.trunc %[[VAL_5]] : i64 to i32
// CHECK:             %[[VAL_7:.*]] = llvm.getelementptr inbounds %[[VAL_0]]{{\[}}%[[VAL_2]], 0] : (!ptr.ptr, i32) -> !ptr.ptr, !llvm.struct<"struct.agg1_t", (i32, i32)>
// CHECK:             llvm.store %[[VAL_6]], %[[VAL_7]] {tbaa = [#[[$TAG_3]]]} : i32, !ptr.ptr
// CHECK:             llvm.return
// CHECK:           }

llvm.func @tbaa3(%arg0: !ptr.ptr) {
  %0 = llvm.mlir.constant(1 : i8) : i8
  llvm.store %0, %arg0 {tbaa = [#tbaa_tag_0, #tbaa_tag_1]} : i8, !ptr.ptr
  llvm.return
}

// CHECK:           llvm.func @tbaa3(%[[VAL_0:.*]]: !ptr.ptr) {
// CHECK:             %[[VAL_1:.*]] = llvm.mlir.constant(1 : i8) : i8
// CHECK:             llvm.store %[[VAL_1]], %[[VAL_0]] {tbaa = [#[[$TAG_0]], #[[$TAG_1]]]} : i8, !ptr.ptr
// CHECK:             llvm.return
// CHECK:           }

llvm.func @tbaa4(%arg0: !ptr.ptr) {
  %0 = llvm.mlir.constant(1 : i8) : i8
  llvm.store %0, %arg0 {tbaa = [#tbaa_tag_4]} : i8, !ptr.ptr
  llvm.return
}

// CHECK:           llvm.func @tbaa4(%[[VAL_0:.*]]: !ptr.ptr) {
// CHECK:             %[[VAL_1:.*]] = llvm.mlir.constant(1 : i8) : i8
// CHECK:             llvm.store %[[VAL_1]], %[[VAL_0]] {tbaa = [#[[$TAG_4]]]} : i8, !ptr.ptr
// CHECK:             llvm.return
// CHECK:           }
