...
llvm.func @memset() -> i32 {
  ...
  %1 = llvm.alloca %0 x !llvm.array<10 x i32> {alignment = 8 : i64} : (i32) -> !ptr.ptr
  ...
  "llvm.intr.memset"(%1, %memset_value, %memset_len) <{isVolatile = false}> : (!ptr.ptr, i8, i32) -> ()
  %2 = llvm.getelementptr %1[0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<10 x i32>
  %3 = llvm.load %2 : !ptr.ptr -> i32
  llvm.return %3 : i32
}
...
llvm.func @memset_no_volatile() -> i32 {
  ...
  "llvm.intr.memset"(%1, %memset_value, %memset_len) <{isVolatile = true}> : (!ptr.ptr, i8, i32) -> ()
  %2 = llvm.getelementptr %1[0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<10 x i32>
  %3 = llvm.load %2 : !ptr.ptr -> i32
  llvm.return %3 : i32
}
...
llvm.func @indirect_memset() -> i32 {
  ...
  %2 = llvm.getelementptr %1[0, 0] : (!ptr.ptr) -> !ptr.ptr, !llvm.struct<"foo", (i32, i32)>
  // CHECK: "llvm.intr.memset"(%[[ALLOCA]], %[[MEMSET_VALUE]], %[[MEMSET_LEN]]) <{isVolatile = false}>
  "llvm.intr.memset"(%2, %memset_value, %memset_len) <{isVolatile = false}> : (!ptr.ptr, i8, i32) -> ()
  %3 = llvm.load %2 : !ptr.ptr -> i32
  llvm.return %3 : i32
}
...
llvm.func @memset_double_use() -> i32 {
  ...
  // CHECK-DAG: %[[MEMSET_LEN:.*]] = llvm.mlir.constant(4 : i32) : i32
  %0 = llvm.mlir.constant(1 : i32) : i32
  %1 = llvm.alloca %0 x !llvm.struct<"foo", (i32, f32)> {alignment = 8 : i64} : (i32) -> !ptr.ptr
  %memset_value = llvm.mlir.constant(42 : i8) : i8
  ...
  // CHECK-NOT: "llvm.intr.memset"
  "llvm.intr.memset"(%1, %memset_value, %memset_len) <{isVolatile = false}> : (!ptr.ptr, i8, i32) -> ()
  %2 = llvm.getelementptr %1[0, 0] : (!ptr.ptr) -> !ptr.ptr, !llvm.struct<"foo", (i32, f32)>
  %3 = llvm.load %2 : !ptr.ptr -> i32
  %4 = llvm.getelementptr %1[0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.struct<"foo", (i32, f32)>
  %5 = llvm.load %4 : !ptr.ptr -> f32
...
llvm.func @memset_considers_alignment() -> i32 {
  ...
  // CHECK-DAG: %[[MEMSET_LEN:.*]] = llvm.mlir.constant(4 : i32) : i32
  %0 = llvm.mlir.constant(1 : i32) : i32
  %1 = llvm.alloca %0 x !llvm.struct<"foo", (i8, i32, f32)> {alignment = 8 : i64} : (i32) -> !ptr.ptr
  %memset_value = llvm.mlir.constant(42 : i8) : i8
  ...
  // CHECK-NOT: "llvm.intr.memset"
  "llvm.intr.memset"(%1, %memset_value, %memset_len) <{isVolatile = false}> : (!ptr.ptr, i8, i32) -> ()
  %2 = llvm.getelementptr %1[0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.struct<"foo", (i8, i32, f32)>
  %3 = llvm.load %2 : !ptr.ptr -> i32
  %4 = llvm.getelementptr %1[0, 2] : (!ptr.ptr) -> !ptr.ptr, !llvm.struct<"foo", (i8, i32, f32)>
  %5 = llvm.load %4 : !ptr.ptr -> f32
  // We use this exotic bitcast to use the f32 easily. Semantics do not matter here.
  %6 = llvm.bitcast %5 : f32 to i32
  %7 = llvm.add %3, %6 : i32
...
llvm.func @memset_considers_packing() -> i32 {
  ...
  %0 = llvm.mlir.constant(1 : i32) : i32
  %1 = llvm.alloca %0 x !llvm.struct<"foo", packed (i8, i32, f32)> {alignment = 8 : i64} : (i32) -> !ptr.ptr
  %memset_value = llvm.mlir.constant(42 : i8) : i8
  ...
  // CHECK-NOT: "llvm.intr.memset"
  "llvm.intr.memset"(%1, %memset_value, %memset_len) <{isVolatile = false}> : (!ptr.ptr, i8, i32) -> ()
  %2 = llvm.getelementptr %1[0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.struct<"foo", packed (i8, i32, f32)>
  %3 = llvm.load %2 : !ptr.ptr -> i32
  %4 = llvm.getelementptr %1[0, 2] : (!ptr.ptr) -> !ptr.ptr, !llvm.struct<"foo", packed (i8, i32, f32)>
  %5 = llvm.load %4 : !ptr.ptr -> f32
  // We use this exotic bitcast to use the f32 easily. Semantics do not matter here.
  %6 = llvm.bitcast %5 : f32 to i32
  %7 = llvm.add %3, %6 : i32
...
// CHECK-SAME: (%[[OTHER_ARRAY:.*]]: !ptr.ptr)
llvm.func @memcpy_dest(%other_array: !ptr.ptr) -> i32 {
  // CHECK-DAG: %[[ALLOCA_LEN:.*]] = llvm.mlir.constant(1 : i32) : i32
  // CHECK-DAG: %[[ALLOCA:.*]] = llvm.alloca %[[ALLOCA_LEN]] x i32
  // After SROA, only one i32 will be actually used, so only 4 bytes will be set.
  // CHECK-DAG: %[[MEMCPY_LEN:.*]] = llvm.mlir.constant(4 : i32) : i32
  %0 = llvm.mlir.constant(1 : i32) : i32
  %1 = llvm.alloca %0 x !llvm.array<10 x i32> : (i32) -> !ptr.ptr
  %memcpy_len = llvm.mlir.constant(40 : i32) : i32
  // CHECK: %[[SLOT_IN_OTHER:.*]] = llvm.getelementptr %[[OTHER_ARRAY]][0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<10 x i32>
  // CHECK: "llvm.intr.memcpy"(%[[ALLOCA]], %[[SLOT_IN_OTHER]], %[[MEMCPY_LEN]]) <{isVolatile = false}>
  "llvm.intr.memcpy"(%1, %other_array, %memcpy_len) <{isVolatile = false}> : (!ptr.ptr, !ptr.ptr, i32) -> ()
  %2 = llvm.getelementptr %1[0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<10 x i32>
  %3 = llvm.load %2 : !ptr.ptr -> i32
  llvm.return %3 : i32
}
...
// CHECK-SAME: (%[[OTHER_ARRAY:.*]]: !ptr.ptr)
llvm.func @memcpy_src(%other_array: !ptr.ptr) -> i32 {
  // CHECK-DAG: %[[ALLOCA_LEN:.*]] = llvm.mlir.constant(1 : i32) : i32
  // After SROA, only one i32 will be actually used, so only 4 bytes will be set.
  // CHECK-DAG: %[[MEMCPY_LEN:.*]] = llvm.mlir.constant(4 : i32) : i32
  // CHECK-COUNT-4: = llvm.alloca %[[ALLOCA_LEN]] x i32
  %0 = llvm.mlir.constant(1 : i32) : i32
  %1 = llvm.alloca %0 x !llvm.array<4 x i32> : (i32) -> !ptr.ptr
  ...
  // CHECK-DAG: %[[SLOT_IN_OTHER:.*]] = llvm.getelementptr %[[OTHER_ARRAY]][0, 0] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<4 x i32>
  // CHECK-DAG: "llvm.intr.memcpy"(%[[SLOT_IN_OTHER]], %{{.*}}, %[[MEMCPY_LEN]]) <{isVolatile = false}>
  // CHECK-DAG: %[[SLOT_IN_OTHER:.*]] = llvm.getelementptr %[[OTHER_ARRAY]][0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<4 x i32>
  // CHECK-DAG: "llvm.intr.memcpy"(%[[SLOT_IN_OTHER]], %{{.*}}, %[[MEMCPY_LEN]]) <{isVolatile = false}>
  // CHECK-DAG: %[[SLOT_IN_OTHER:.*]] = llvm.getelementptr %[[OTHER_ARRAY]][0, 2] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<4 x i32>
  // CHECK-DAG: "llvm.intr.memcpy"(%[[SLOT_IN_OTHER]], %{{.*}}, %[[MEMCPY_LEN]]) <{isVolatile = false}>
  // CHECK-DAG: %[[SLOT_IN_OTHER:.*]] = llvm.getelementptr %[[OTHER_ARRAY]][0, 3] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<4 x i32>
  // CHECK-DAG: "llvm.intr.memcpy"(%[[SLOT_IN_OTHER]], %{{.*}}, %[[MEMCPY_LEN]]) <{isVolatile = false}>
  "llvm.intr.memcpy"(%other_array, %1, %memcpy_len) <{isVolatile = false}> : (!ptr.ptr, !ptr.ptr, i32) -> ()
  %2 = llvm.getelementptr %1[0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<4 x i32>
  %3 = llvm.load %2 : !ptr.ptr -> i32
  llvm.return %3 : i32
}
...
llvm.func @memcpy_double() -> i32 {
  ...
  %1 = llvm.alloca %0 x !llvm.array<1 x i32> : (i32) -> !ptr.ptr
  %2 = llvm.alloca %0 x !llvm.array<1 x i32> : (i32) -> !ptr.ptr
  %memcpy_len = llvm.mlir.constant(4 : i32) : i32
  // CHECK-NOT: "llvm.intr.memcpy"
  // CHECK: "llvm.intr.memcpy"(%{{.*}}, %{{.*}}, %[[MEMCPY_LEN]]) <{isVolatile = false}>
  // CHECK-NOT: "llvm.intr.memcpy"
  "llvm.intr.memcpy"(%1, %2, %memcpy_len) <{isVolatile = false}> : (!ptr.ptr, !ptr.ptr, i32) -> ()
  %3 = llvm.getelementptr %1[0, 0] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<1 x i32>
  %4 = llvm.load %3 : !ptr.ptr -> i32
  llvm.return %4 : i32
}
...
// CHECK-SAME: (%[[OTHER_ARRAY:.*]]: !ptr.ptr)
llvm.func @memcpy_no_partial(%other_array: !ptr.ptr) -> i32 {
  // CHECK-DAG: %[[ALLOCA_LEN:.*]] = llvm.mlir.constant(1 : i32) : i32
  // CHECK-DAG: %[[ALLOCA:.*]] = llvm.alloca %[[ALLOCA_LEN]] x !llvm.array<10 x i32>
...
// CHECK-SAME: (%[[OTHER_ARRAY:.*]]: !ptr.ptr)
llvm.func @memcpy_no_volatile(%other_array: !ptr.ptr) -> i32 {
  // CHECK-DAG: %[[ALLOCA_LEN:.*]] = llvm.mlir.constant(1 : i32) : i32
  // CHECK-DAG: %[[ALLOCA:.*]] = llvm.alloca %[[ALLOCA_LEN]] x !llvm.array<10 x i32>
  ...
  "llvm.intr.memcpy"(%1, %other_array, %memcpy_len) <{isVolatile = true}> : (!ptr.ptr, !ptr.ptr, i32) -> ()
  %2 = llvm.getelementptr %1[0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<10 x i32>
  %3 = llvm.load %2 : !ptr.ptr -> i32
  llvm.return %3 : i32
}
...
// CHECK-SAME: (%[[OTHER_ARRAY:.*]]: !ptr.ptr)
llvm.func @memmove_dest(%other_array: !ptr.ptr) -> i32 {
  // CHECK-DAG: %[[ALLOCA_LEN:.*]] = llvm.mlir.constant(1 : i32) : i32
  // CHECK-DAG: %[[ALLOCA:.*]] = llvm.alloca %[[ALLOCA_LEN]] x i32
  // After SROA, only one i32 will be actually used, so only 4 bytes will be set.
  ...
  "llvm.intr.memmove"(%1, %other_array, %memmove_len) <{isVolatile = false}> : (!ptr.ptr, !ptr.ptr, i32) -> ()
  %2 = llvm.getelementptr %1[0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<10 x i32>
  %3 = llvm.load %2 : !ptr.ptr -> i32
  llvm.return %3 : i32
}
...
// CHECK-SAME: (%[[OTHER_ARRAY:.*]]: !ptr.ptr)
llvm.func @memmove_src(%other_array: !ptr.ptr) -> i32 {
  // CHECK-DAG: %[[ALLOCA_LEN:.*]] = llvm.mlir.constant(1 : i32) : i32
  // After SROA, only one i32 will be actually used, so only 4 bytes will be set.
  // CHECK-DAG: %[[MEMMOVE_LEN:.*]] = llvm.mlir.constant(4 : i32) : i32
  // CHECK-COUNT-4: = llvm.alloca %[[ALLOCA_LEN]] x i32
  ...
  // CHECK-DAG: %[[SLOT_IN_OTHER:.*]] = llvm.getelementptr %[[OTHER_ARRAY]][0, 3] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<4 x i32>
  // CHECK-DAG: "llvm.intr.memmove"(%[[SLOT_IN_OTHER]], %{{.*}}, %[[MEMMOVE_LEN]]) <{isVolatile = false}>
  "llvm.intr.memmove"(%other_array, %1, %memmove_len) <{isVolatile = false}> : (!ptr.ptr, !ptr.ptr, i32) -> ()
  %2 = llvm.getelementptr %1[0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<4 x i32>
  %3 = llvm.load %2 : !ptr.ptr -> i32
  llvm.return %3 : i32
}
...
// CHECK-SAME: (%[[OTHER_ARRAY:.*]]: !ptr.ptr)
llvm.func @memcpy_inline_dest(%other_array: !ptr.ptr) -> i32 {
  // CHECK-DAG: %[[ALLOCA_LEN:.*]] = llvm.mlir.constant(1 : i32) : i32
  // CHECK-DAG: %[[ALLOCA:.*]] = llvm.alloca %[[ALLOCA_LEN]] x i32
  // After SROA, only one i32 will be actually used, so only 4 bytes will be set.
  %0 = llvm.mlir.constant(1 : i32) : i32
  ...
  "llvm.intr.memcpy.inline"(%1, %other_array) <{isVolatile = false, len = 40 : i32}> : (!ptr.ptr, !ptr.ptr) -> ()
  %2 = llvm.getelementptr %1[0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<10 x i32>
  %3 = llvm.load %2 : !ptr.ptr -> i32
  llvm.return %3 : i32
}
...
// CHECK-SAME: (%[[OTHER_ARRAY:.*]]: !ptr.ptr)
llvm.func @memcpy_inline_src(%other_array: !ptr.ptr) -> i32 {
  // CHECK-DAG: %[[ALLOCA_LEN:.*]] = llvm.mlir.constant(1 : i32) : i32
  // After SROA, only one i32 will be actually used, so only 4 bytes will be set.
  // CHECK-COUNT-4: = llvm.alloca %[[ALLOCA_LEN]] x i32
  %0 = llvm.mlir.constant(1 : i32) : i32
  ...
  // CHECK-DAG: %[[SLOT_IN_OTHER:.*]] = llvm.getelementptr %[[OTHER_ARRAY]][0, 3] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<4 x i32>
  // CHECK-DAG: "llvm.intr.memcpy.inline"(%[[SLOT_IN_OTHER]], %{{.*}}) <{isVolatile = false, len = 4 : i32}>
  "llvm.intr.memcpy.inline"(%other_array, %1) <{isVolatile = false, len = 16 : i32}> : (!ptr.ptr, !ptr.ptr) -> ()
  %2 = llvm.getelementptr %1[0, 1] : (!ptr.ptr) -> !ptr.ptr, !llvm.array<4 x i32>
  %3 = llvm.load %2 : !ptr.ptr -> i32
  llvm.return %3 : i32
}
