...
module attributes {"test.name" = "Invoke call"} {
  ...
  llvm.func @invokeLandingpad() -> i32 attributes { personality = @__gxx_personality_v0 } {
    ...
    %5 = llvm.mlir.addressof @_ZTIi : !ptr.ptr
    %6 = llvm.mlir.constant(1 : i32) : i32
    %7 = llvm.alloca %6 x i8 : (i32) -> !ptr.ptr
    %8 = llvm.invoke @foo(%6) to ^bb2 unwind ^bb1 : (i32) -> !llvm.struct<(i32, f64, i32)>

  ^bb1:
    %10 = llvm.landingpad cleanup (catch %3 : !ptr.ptr) (catch %5 : !ptr.ptr) (filter %2 : !llvm.array<1 x i8>) : !llvm.struct<(ptr, i32)>
    %11 = llvm.intr.eh.typeid.for %5 : (!ptr.ptr) -> i32
  ...
  ^bb3:
    llvm.invoke @bar(%7, %5, %4) to ^bb2 unwind ^bb1 : (!ptr.ptr, !ptr.ptr, !ptr.ptr) -> ()
