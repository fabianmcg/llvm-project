...
llvm.func @exotic_target_memset(%memset_value: i8) -> i40 {
  %0 = llvm.mlir.constant(1 : i32) : i32
  %1 = llvm.alloca %0 x i40 {alignment = 4 : i64} : (i32) -> !ptr.ptr
  ...
  // CHECK-NOT: "llvm.intr.memset"
  %2 = llvm.load %1 {alignment = 4 : i64} : !ptr.ptr -> i40
...
llvm.func @only_byte_aligned_integers_memset() -> i10 {
  ...
  // CHECK-DAG: %[[MEMSET_LEN:.*]] = llvm.mlir.constant(2 : i32) : i32
  %0 = llvm.mlir.constant(1 : i32) : i32
  %1 = llvm.alloca %0 x i10 {alignment = 4 : i64} : (i32) -> !ptr.ptr
  %memset_value = llvm.mlir.constant(42 : i8) : i8
  %memset_len = llvm.mlir.constant(2 : i32) : i32
  // CHECK: "llvm.intr.memset"(%[[ALLOCA]], %[[MEMSET_VALUE]], %[[MEMSET_LEN]]) <{isVolatile = false}>
  "llvm.intr.memset"(%1, %memset_value, %memset_len) <{isVolatile = false}> : (!ptr.ptr, i8, i32) -> ()
  %2 = llvm.load %1 {alignment = 4 : i64} : !ptr.ptr -> i10
  llvm.return %2 : i10
}
...
// CHECK-SAME: (%[[SOURCE:.*]]: !ptr.ptr)
llvm.func @basic_memcpy(%source: !ptr.ptr) -> i32 {
  %0 = llvm.mlir.constant(1 : i32) : i32
  %1 = llvm.alloca %0 x i32 : (i32) -> !ptr.ptr
  %is_volatile = llvm.mlir.constant(false) : i1
  %memcpy_len = llvm.mlir.constant(4 : i32) : i32
  "llvm.intr.memcpy"(%1, %source, %memcpy_len) <{isVolatile = false}> : (!ptr.ptr, !ptr.ptr, i32) -> ()
  // CHECK-NOT: "llvm.intr.memcpy"
  // CHECK: %[[LOADED:.*]] = llvm.load %[[SOURCE]] : !ptr.ptr -> i32
  // CHECK-NOT: "llvm.intr.memcpy"
...
// CHECK-SAME: (%[[DESTINATION:.*]]: !ptr.ptr)
llvm.func @basic_memcpy_dest(%destination: !ptr.ptr) -> i32 {
  %0 = llvm.mlir.constant(1 : i32) : i32
  ...
  %1 = llvm.alloca %0 x i32 : (i32) -> !ptr.ptr
  llvm.store %data, %1 : i32, !ptr.ptr
  "llvm.intr.memcpy"(%destination, %1, %memcpy_len) <{isVolatile = false}> : (!ptr.ptr, !ptr.ptr, i32) -> ()
  // CHECK-NOT: "llvm.intr.memcpy"
  // CHECK: llvm.store %[[DATA]], %[[DESTINATION]] : i32, !ptr.ptr
  // CHECK-NOT: "llvm.intr.memcpy"
...
llvm.func @double_memcpy() -> i32 {
  ...
  %1 = llvm.alloca %0 x i32 : (i32) -> !ptr.ptr
  %2 = llvm.alloca %0 x i32 : (i32) -> !ptr.ptr
  llvm.store %data, %1 : i32, !ptr.ptr
  "llvm.intr.memcpy"(%2, %1, %memcpy_len) <{isVolatile = false}> : (!ptr.ptr, !ptr.ptr, i32) -> ()

  %res = llvm.load %2 : !ptr.ptr -> i32
...
llvm.func @ignore_self_memcpy() -> i32 {
  ...
  "llvm.intr.memcpy"(%1, %1, %memcpy_len) <{isVolatile = false}> : (!ptr.ptr, !ptr.ptr, i32) -> ()

  %res = llvm.load %1 : !ptr.ptr -> i32
  llvm.return %res : i32
}
...
// CHECK-SAME: (%[[SOURCE:.*]]: !ptr.ptr)
llvm.func @ignore_partial_memcpy(%source: !ptr.ptr) -> i32 {
  // CHECK-DAG: %[[ALLOCA_LEN:.*]] = llvm.mlir.constant(1 : i32) : i32
  %0 = llvm.mlir.constant(1 : i32) : i32
  %is_volatile = llvm.mlir.constant(false) : i1
...
// CHECK-SAME: (%[[SOURCE:.*]]: !ptr.ptr)
llvm.func @ignore_volatile_memcpy(%source: !ptr.ptr) -> i32 {
  // CHECK-DAG: %[[ALLOCA_LEN:.*]] = llvm.mlir.constant(1 : i32) : i32
  ...
  "llvm.intr.memcpy"(%1, %source, %memcpy_len) <{isVolatile = true}> : (!ptr.ptr, !ptr.ptr, i32) -> ()
...
// CHECK-SAME: (%[[SOURCE:.*]]: !ptr.ptr)
llvm.func @basic_memmove(%source: !ptr.ptr) -> i32 {
  %0 = llvm.mlir.constant(1 : i32) : i32
  %1 = llvm.alloca %0 x i32 : (i32) -> !ptr.ptr
  %is_volatile = llvm.mlir.constant(false) : i1
  %memmove_len = llvm.mlir.constant(4 : i32) : i32
  "llvm.intr.memmove"(%1, %source, %memmove_len) <{isVolatile = false}> : (!ptr.ptr, !ptr.ptr, i32) -> ()
...
// CHECK-SAME: (%[[SOURCE:.*]]: !ptr.ptr)
llvm.func @basic_memcpy_inline(%source: !ptr.ptr) -> i32 {
  %0 = llvm.mlir.constant(1 : i32) : i32
  %1 = llvm.alloca %0 x i32 : (i32) -> !ptr.ptr
  %is_volatile = llvm.mlir.constant(false) : i1
  "llvm.intr.memcpy.inline"(%1, %source) <{isVolatile = false, len = 4 : i32}> : (!ptr.ptr, !ptr.ptr) -> ()
