...
llvm.func @invalid_noalias_attr_type(%0 : !ptr.ptr {llvm.noalias = 10 : i32})
...
llvm.func @invalid_noundef_attr_type(%0 : i32 {llvm.noundef = !ptr.ptr})
...
llvm.func @invalid_dereferenceable_attr_type(%0 : !ptr.ptr {llvm.dereferenceable = !llvm.struct<(i32)>})
...
llvm.func @invalid_dereferenceable_or_null_attr_type(%0 : !ptr.ptr {llvm.dereferenceable_or_null = !llvm.struct<(i32)>})

// -----

// expected-error@below {{"llvm.inreg" should be a unit attribute}}
llvm.func @invalid_inreg_attr_type(%0 : i32 {llvm.inreg = !ptr.ptr})
...
llvm.func @invalid_nocapture_attr_type(%0 : !ptr.ptr {llvm.nocapture = f32})
...
llvm.func @invalid_nofree_attr_type(%0 : !ptr.ptr {llvm.nofree = f32})
...
llvm.func @invalid_nonnull_attr_type(%0 : !ptr.ptr {llvm.nonnull = f32})
...
llvm.func @invalid_preallocated_attr_type(%0 : !ptr.ptr {llvm.preallocated})

// -----

// expected-error@below {{"llvm.returned" should be a unit attribute}}
llvm.func @invalid_returned_attr_type(%0 : i32 {llvm.returned = !ptr.ptr})
...
// expected-error @below{{"llvm.align" should be an integer attribute}}
llvm.func @alignattr_ret() -> (!ptr.ptr {llvm.align = 1.0 : f32})
...
// expected-error @below{{"llvm.noalias" should be a unit attribute}}
llvm.func @noaliasattr_ret() -> (!ptr.ptr {llvm.noalias = 1})
...
// expected-error @below{{"llvm.noundef" should be a unit attribute}}
llvm.func @noundefattr_ret() -> (!ptr.ptr {llvm.noundef = 1})
