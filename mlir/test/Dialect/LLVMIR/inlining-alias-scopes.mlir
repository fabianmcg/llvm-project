...
llvm.func @foo(%arg0: !ptr.ptr, %arg1: !ptr.ptr) {
  %0 = llvm.mlir.constant(5 : i64) : i64
  llvm.intr.experimental.noalias.scope.decl #alias_scope
  %2 = llvm.load %arg1 {alias_scopes = [#alias_scope], alignment = 4 : i64, noalias_scopes = [#alias_scope1]} : !ptr.ptr -> f32
  %3 = llvm.getelementptr inbounds %arg0[%0] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %2, %3 {alias_scopes = [#alias_scope1], alignment = 4 : i64, noalias_scopes = [#alias_scope]} : f32, !ptr.ptr
  llvm.return
}
...
llvm.func @bar(%arg0: !ptr.ptr, %arg1: !ptr.ptr, %arg2: !ptr.ptr) {
  llvm.call @foo(%arg0, %arg2) : (!ptr.ptr, !ptr.ptr) -> ()
  llvm.return
}
...
// CHECK: llvm.store
// CHECK-NOT: {{(no)?}}alias_scopes =
llvm.func @callee_with_metadata(%arg0: !ptr.ptr, %arg1: !ptr.ptr, %arg2: !ptr.ptr) {
  %0 = llvm.mlir.constant(5 : i64) : i64
  %1 = llvm.mlir.constant(8 : i64) : i64
  %2 = llvm.mlir.constant(7 : i64) : i64
  %3 = llvm.load %arg2 {alignment = 4 : i64, noalias_scopes = [#alias_scope, #alias_scope1]} : !ptr.ptr -> f32
  %4 = llvm.getelementptr inbounds %arg0[%0] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %3, %4 {alias_scopes = [#alias_scope], alignment = 4 : i64, noalias_scopes = [#alias_scope1]} : f32, !ptr.ptr
  %5 = llvm.getelementptr inbounds %arg1[%1] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %3, %5 {alias_scopes = [#alias_scope1], alignment = 4 : i64, noalias_scopes = [#alias_scope]} : f32, !ptr.ptr
  %6 = llvm.load %arg2 {alignment = 4 : i64} : !ptr.ptr -> f32
  %7 = llvm.getelementptr inbounds %arg0[%2] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %6, %7 {alignment = 4 : i64} : f32, !ptr.ptr
  llvm.return
}
...
llvm.func @callee_without_metadata(%arg0: !ptr.ptr, %arg1: !ptr.ptr, %arg2: !ptr.ptr) {
  %0 = llvm.mlir.constant(5 : i64) : i64
  %1 = llvm.mlir.constant(8 : i64) : i64
  %2 = llvm.mlir.constant(7 : i64) : i64
  %3 = llvm.load %arg2 {alignment = 4 : i64} : !ptr.ptr -> f32
  %4 = llvm.getelementptr inbounds %arg0[%0] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %3, %4 {alignment = 4 : i64} : f32, !ptr.ptr
  %5 = llvm.getelementptr inbounds %arg1[%1] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %3, %5 {alignment = 4 : i64} : f32, !ptr.ptr
  %6 = llvm.load %arg2 {alignment = 4 : i64} : !ptr.ptr -> f32
  %7 = llvm.getelementptr inbounds %arg0[%2] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %6, %7 {alignment = 4 : i64} : f32, !ptr.ptr
  llvm.return
...
llvm.func @caller(%arg0: !ptr.ptr, %arg1: !ptr.ptr, %arg2: !ptr.ptr) {
  %0 = llvm.load %arg2 {alias_scopes = [#alias_scope2], alignment = 8 : i64} : !ptr.ptr -> !ptr.ptr
  llvm.call @callee_with_metadata(%arg0, %arg1, %0) {noalias_scopes = [#alias_scope2]} : (!ptr.ptr, !ptr.ptr, !ptr.ptr) -> ()
  llvm.call @callee_with_metadata(%arg1, %arg1, %arg0) {alias_scopes = [#alias_scope2]} : (!ptr.ptr, !ptr.ptr, !ptr.ptr) -> ()
  llvm.call @callee_without_metadata(%arg0, %arg1, %0) {noalias_scopes = [#alias_scope2]} : (!ptr.ptr, !ptr.ptr, !ptr.ptr) -> ()
  llvm.call @callee_without_metadata(%arg1, %arg1, %arg0) {alias_scopes = [#alias_scope2]} : (!ptr.ptr, !ptr.ptr, !ptr.ptr) -> ()
  llvm.return
}
...
llvm.func @foo(%arg0: !ptr.ptr {llvm.noalias}, %arg1: !ptr.ptr {llvm.noalias}) {
  %0 = llvm.mlir.constant(5 : i64) : i64
  %1 = llvm.load %arg1 {alignment = 4 : i64} : !ptr.ptr -> f32
  %2 = llvm.getelementptr inbounds %arg0[%0] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %1, %2 {alignment = 4 : i64} : f32, !ptr.ptr
  llvm.return
}
...
llvm.func @might_return_arg_derived(!ptr.ptr) -> !ptr.ptr

llvm.func @foo(%arg0: !ptr.ptr {llvm.noalias}, %arg1: !ptr.ptr {llvm.noalias}) {
  %0 = llvm.mlir.constant(5 : i64) : i32
  %1 = llvm.call @might_return_arg_derived(%arg0) : (!ptr.ptr) -> !ptr.ptr
  llvm.store %0, %1 : i32, !ptr.ptr
  llvm.return
}
...
llvm.func @block_arg(%arg0: !ptr.ptr {llvm.noalias}, %arg1: !ptr.ptr {llvm.noalias}) {
  %0 = llvm.mlir.constant(5 : i64) : i32
  %1 = llvm.call @random() : () -> i1
  llvm.cond_br %1, ^bb0(%arg0 : !ptr.ptr), ^bb0(%arg1 : !ptr.ptr)

^bb0(%arg2: !ptr.ptr):
  llvm.store %0, %arg2 : i32, !ptr.ptr
  llvm.return
}
...
llvm.func @bar(%arg0: !ptr.ptr, %arg1: !ptr.ptr, %arg2: !ptr.ptr) {
  llvm.call @block_arg(%arg0, %arg2) : (!ptr.ptr, !ptr.ptr) -> ()
  llvm.return
}
...
llvm.func @block_arg(%arg0: !ptr.ptr {llvm.noalias}, %arg1: !ptr.ptr {llvm.noalias}) {
  ...
  %2 = llvm.alloca %1 x i32 : (i64) -> !ptr.ptr
  %3 = llvm.call @random() : () -> i1
  llvm.cond_br %3, ^bb0(%arg0 : !ptr.ptr), ^bb0(%2 : !ptr.ptr)
...
llvm.func @unknown() -> !ptr.ptr
llvm.func @random() -> i1

llvm.func @unknown_object(%arg0: !ptr.ptr {llvm.noalias}, %arg1: !ptr.ptr {llvm.noalias}) {
  %0 = llvm.mlir.constant(5 : i64) : i32
  %1 = llvm.call @random() : () -> i1
  %2 = llvm.call @unknown() : () -> !ptr.ptr
  llvm.cond_br %1, ^bb0(%arg0 : !ptr.ptr), ^bb0(%2 : !ptr.ptr)
...
// CHECK-NOT: noalias_scopes
llvm.func @bar(%arg0: !ptr.ptr, %arg1: !ptr.ptr, %arg2: !ptr.ptr) {
  llvm.call @unknown_object(%arg0, %arg2) : (!ptr.ptr, !ptr.ptr) -> ()
  llvm.return
}
...
llvm.func @supported_operations(%arg0: !ptr.ptr {llvm.noalias}, %arg1: !ptr.ptr {llvm.noalias}) {
  %0 = llvm.mlir.constant(5 : i64) : i32
  llvm.store %0, %arg1 : i32, !ptr.ptr
  %1 = llvm.load %arg1 : !ptr.ptr -> i32
  "llvm.intr.memcpy"(%arg0, %arg1, %1) <{ isVolatile = false }> : (!ptr.ptr, !ptr.ptr, i32) -> ()
  "llvm.intr.memmove"(%arg0, %arg1, %1) <{ isVolatile = false }> : (!ptr.ptr, !ptr.ptr, i32) -> ()
  "llvm.intr.memcpy.inline"(%arg0, %arg1) <{ isVolatile = false, len = 4 : i32}> : (!ptr.ptr, !ptr.ptr) -> ()
  %2 = llvm.trunc %0 : i32 to i8
  "llvm.intr.memset"(%arg0, %2, %1) <{ isVolatile = false}> : (!ptr.ptr, i8, i32) -> ()
  %3 = llvm.cmpxchg %arg0, %0, %1 seq_cst seq_cst : !ptr.ptr, i32
  %4 = llvm.atomicrmw add %arg0, %0 seq_cst : !ptr.ptr, i32
  llvm.return
}
...
// CHECK-SAME: noalias_scopes = [#[[$ARG1_SCOPE]]]
llvm.func @bar(%arg0: !ptr.ptr, %arg1: !ptr.ptr, %arg2: !ptr.ptr) {
  llvm.call @supported_operations(%arg0, %arg2) : (!ptr.ptr, !ptr.ptr) -> ()
  llvm.return
}
