...
// CHECK-SAME: !ptr.future<#ptr.generic_space, f32>
func.func @future_typed(%arg0: !ptr.future<#ptr.generic_space, f32>) {
  return
}
...
// CHECK-SAME: !ptr.future<#ptr.generic_space>
func.func @future_empty(%arg0: !ptr.future<#ptr.generic_space>) {
  return
}
...
// CHECK-SAME: !ptr.future<#ptr.generic_space, !ptr.ptr<#ptr.generic_space>>
