...
func.func @foo(%lb : index, %ub : index, %step : index) {
  ...
  omp.wsloop reduction(@foo -> %0 : !ptr.ptr)
  for (%iv) : index = (%lb) to (%ub) step (%step) {
    %2 = arith.constant 2.0 : f32
    omp.reduction %2, %1 : f32, !ptr.ptr
    omp.yield
...
func.func @foo(%lb : index, %ub : index, %step : index) {
  ...
  omp.wsloop reduction(@add_f32 -> %0 : !ptr.ptr, @add_f32 -> %0 : !ptr.ptr)
  for (%iv) : index = (%lb) to (%ub) step (%step) {
    %2 = arith.constant 2.0 : f32
    omp.reduction %2, %0 : f32, !ptr.ptr
    omp.yield
  }
  return
}
...
func.func @foo(%lb : index, %ub : index, %step : index, %mem : memref<1xf32>) {
  ...
  // expected-error @below {{expected accumulator ('memref<1xf32>') to be the same type as reduction declaration ('!ptr.ptr')}}
...
func.func @omp_task(%ptr: !ptr.ptr) {
  ...
  omp.task in_reduction(@add_f32 -> %ptr : !ptr.ptr, @add_f32 -> %ptr : !ptr.ptr) {
    // CHECK: "test.foo"() : () -> ()
    "test.foo"() : () -> ()
    // CHECK: omp.terminator
    omp.terminator
...
func.func @omp_task(%mem: memref<1xf32>) {
  // expected-error @below {{op expected accumulator ('memref<1xf32>') to be the same type as reduction declaration ('!ptr.ptr')}}
...
func.func @taskloop(%lb: i32, %ub: i32, %step: i32) {
  ...
  ^bb0(%arg3: i32, %arg4: i32):
    "omp.terminator"() : () -> ()
  }) {operandSegmentSizes = array<i32: 2, 2, 2, 0, 0, 0, 2, 0, 0, 0, 0, 0>, reductions = [@add_f32]} : (i32, i32, i32, i32, i32, i32, !ptr.ptr, !ptr.ptr) -> ()
  return
}
...
func.func @taskloop(%lb: i32, %ub: i32, %step: i32) {
  ...
  ^bb0(%arg3: i32, %arg4: i32):
    "omp.terminator"() : () -> ()
  }) {operandSegmentSizes = array<i32: 2, 2, 2, 0, 0, 0, 1, 0, 0, 0, 0, 0>, reductions = [@add_f32, @add_f32]} : (i32, i32, i32, i32, i32, i32, !ptr.ptr) -> ()
  return
}
...
func.func @taskloop(%lb: i32, %ub: i32, %step: i32) {
  ...
  ^bb0(%arg3: i32, %arg4: i32):
    "omp.terminator"() : () -> ()
  }) {in_reductions = [@add_f32], operandSegmentSizes = array<i32: 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 0, 0>} : (i32, i32, i32, i32, i32, i32, !ptr.ptr, !ptr.ptr) -> ()
  return
}
...
func.func @taskloop(%lb: i32, %ub: i32, %step: i32) {
  ...
  ^bb0(%arg3: i32, %arg4: i32):
    "omp.terminator"() : () -> ()
  }) {in_reductions = [@add_f32, @add_f32], operandSegmentSizes = array<i32: 2, 2, 2, 0, 0, 1, 0, 0, 0, 0, 0, 0>} : (i32, i32, i32, i32, i32, i32, !ptr.ptr) -> ()
  return
}
...
func.func @taskloop(%lb: i32, %ub: i32, %step: i32) {
  ...
  omp.taskloop reduction(@add_f32 -> %testf32 : !ptr.ptr, @add_f32 -> %testf32_2 : !ptr.ptr) nogroup
...
func.func @taskloop(%lb: i32, %ub: i32, %step: i32) {
  ...
  omp.taskloop reduction(@add_f32 -> %testf32 : !ptr.ptr) in_reduction(@add_f32 -> %testf32 : !ptr.ptr)
  for (%i, %j) : i32 = (%lb, %ub) to (%ub, %lb) step (%step, %step) {
    omp.terminator
  }
  return
