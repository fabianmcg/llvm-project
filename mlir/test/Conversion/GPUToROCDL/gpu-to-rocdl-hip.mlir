...
gpu.module @test_module {
  ...
  // CHECK-DAG: llvm.func @__ockl_printf_append_string_n(i64, !ptr.ptr, i64, i32) -> i64
  ...
  gpu.func @test_const_printf() {
    ...
    // CHECK-NEXT: %{{.*}} = llvm.call @__ockl_printf_append_string_n(%[[DESC0]], %[[FORMATSTART]], %[[FORMATLEN]], %[[ISLAST]]) : (i64, !ptr.ptr, i64, i32) -> i64
  ...
  gpu.func @test_printf(%arg0: i32) {
    ...
    // CHECK-NEXT: %[[ISLAST:.*]] = llvm.mlir.constant(1 : i32) : i32
    // CHECK-NEXT: %[[ISNTLAST:.*]] = llvm.mlir.constant(0 : i32) : i32
    // CHECK-NEXT: %[[DESC1:.*]] = llvm.call @__ockl_printf_append_string_n(%[[DESC0]], %[[FORMATSTART]], %[[FORMATLEN]], %[[ISNTLAST]]) : (i64, !ptr.ptr, i64, i32) -> i64
