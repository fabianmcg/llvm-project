...
llvm.func @init_mbarrier(%barrier_gen : !ptr.ptr, %barrier : !ptr.ptr<3>, %count : i32, %pred : i1) {
  //CHECK: llvm.inline_asm has_side_effects asm_dialect = att "@$2 mbarrier.init.shared.b64 [$0], $1;", "r,r,b" 
  nvvm.mbarrier.init.shared %barrier, %count, predicate = %pred : !ptr.ptr<3>, i32, i1 
  //CHECK: llvm.inline_asm has_side_effects asm_dialect = att "@$2 mbarrier.init.b64 [$0], $1;", "l,r,b" 
  nvvm.mbarrier.init %barrier_gen, %count, predicate = %pred : !ptr.ptr, i32, i1
  llvm.return
}

// CHECK-LABEL: @init_mbarrier_arrive_expect_tx
llvm.func @init_mbarrier_arrive_expect_tx(%barrier : !ptr.ptr<3>, %txcount : i32, %pred : i1) {
  //CHECK: llvm.inline_asm has_side_effects asm_dialect = att "mbarrier.arrive.expect_tx.shared.b64 _, [$0], $1;", "r,r"
  nvvm.mbarrier.arrive.expect_tx.shared %barrier, %txcount : !ptr.ptr<3>, i32
  //CHECK :  llvm.inline_asm has_side_effects asm_dialect = att "@$2 mbarrier.arrive.expect_tx.shared.b64 _, [$0], $1;", "r,r,b "
  nvvm.mbarrier.arrive.expect_tx.shared %barrier, %txcount, predicate = %pred : !ptr.ptr<3>, i32, i1 
  llvm.return
}

// CHECK-LABEL: @init_mbarrier_arrive_expect_tx_generic
llvm.func @init_mbarrier_arrive_expect_tx_generic(%barrier : !ptr.ptr, %txcount : i32, %pred : i1) {
  // CHECK: llvm.inline_asm has_side_effects asm_dialect = att "mbarrier.arrive.expect_tx.b64 _, [$0], $1;", "l,r" 
  nvvm.mbarrier.arrive.expect_tx %barrier, %txcount : !ptr.ptr, i32
  // CHECK: llvm.inline_asm has_side_effects asm_dialect = att "@$2 mbarrier.arrive.expect_tx.b64 _, [$0], $1;", "l,r,b"
  nvvm.mbarrier.arrive.expect_tx %barrier, %txcount, predicate = %pred : !ptr.ptr, i32, i1 
  llvm.return
}

// CHECK-LABEL: @init_mbarrier_try_wait_shared
llvm.func @init_mbarrier_try_wait_shared(%barrier : !ptr.ptr<3>, %ticks : i32, %phase : i32) {
  ...
  // CHECK-SAME: }",
  // CHECK-SAME: "r,r,r"
   nvvm.mbarrier.try_wait.parity.shared %barrier, %phase, %ticks : !ptr.ptr<3>, i32, i32
  llvm.return
}

// CHECK-LABEL: @init_mbarrier_try_wait
llvm.func @init_mbarrier_try_wait(%barrier : !ptr.ptr, %ticks : i32, %phase : i32){
  // CHECK: llvm.inline_asm has_side_effects asm_dialect = att
  // CHECK-SAME: "{
  // CHECK-SAME: .reg .pred       P1;
  // CHECK-SAME: LAB_WAIT: 
  ...
  // CHECK-SAME: }",
  // CHECK-SAME: "l,r,r"
  nvvm.mbarrier.try_wait.parity %barrier, %phase, %ticks : !ptr.ptr, i32, i32
  llvm.return
}

// CHECK-LABEL: @async_cp
func.func @async_cp(%dst: !ptr.ptr<3>, %src: !ptr.ptr<1>) {
  // CHECK: nvvm.cp.async.shared.global %{{.*}}, %{{.*}}, 16, cache =  ca : !ptr.ptr<3>, !ptr.ptr<1>
  nvvm.cp.async.shared.global %dst, %src, 16, cache =  ca : !ptr.ptr<3>, !ptr.ptr<1>
  // CHECK: nvvm.cp.async.shared.global %{{.*}}, %{{.*}}, 16, cache =  cg : !ptr.ptr<3>, !ptr.ptr<1>
  nvvm.cp.async.shared.global %dst, %src, 16, cache =  cg : !ptr.ptr<3>, !ptr.ptr<1>
  return
}

// CHECK-LABEL: @async_cp_zfill
func.func @async_cp_zfill(%dst: !ptr.ptr<3>, %src: !ptr.ptr<1>, %cpSize: i32) {
  // CHECK: llvm.inline_asm has_side_effects asm_dialect = att 
  // CHECK-SAME: "cp.async.cg.shared.global [$0], [$1], $2, $3;\0A", 
  // CHECK-SAME: "r,l,n,r" %{{.*}}, %{{.*}}, %{{.*}} : (!ptr.ptr<3>, !ptr.ptr<1>, i32, i32) -> ()
  nvvm.cp.async.shared.global %dst, %src, 16, cache =  cg, %cpSize : !ptr.ptr<3>, !ptr.ptr<1>, i32
  // CHECK: llvm.inline_asm has_side_effects asm_dialect = att 
  // CHECK-SAME: "cp.async.ca.shared.global [$0], [$1], $2, $3;\0A", 
  // CHECK-SAME: "r,l,n,r" %{{.*}}, %{{.*}}, %{{.*}} : (!ptr.ptr<3>, !ptr.ptr<1>, i32, i32) -> ()
  nvvm.cp.async.shared.global %dst, %src, 4, cache =  ca, %cpSize : !ptr.ptr<3>, !ptr.ptr<1>, i32
  return
}

// CHECK-LABEL: @tma_load_1d
func.func @tma_load_1d(%tmaDescriptor: !ptr.ptr, %dest : !ptr.ptr<3>, %barrier: !ptr.ptr<3>, %crd0: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, box[%crd0] : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i32
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, box[%crd0], predicate=%p : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i32,i1
  return
}

// CHECK-LABEL: @tma_load_2d
func.func @tma_load_2d(%tmaDescriptor: !ptr.ptr, %dest : !ptr.ptr<3>, %barrier: !ptr.ptr<3>, %crd0: i32, %crd1: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, box[%crd0,%crd1] : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i32, i32
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, box[%crd0,%crd1], predicate=%p  : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i32, i32, i1
  return
}

// CHECK-LABEL: @tma_load_3d
func.func @tma_load_3d(%tmaDescriptor: !ptr.ptr, %dest : !ptr.ptr<3>, %barrier: !ptr.ptr<3>, %crd0: i32, %crd1: i32, %crd2: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, box[%crd0,%crd1,%crd2] : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i32, i32, i32
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, box[%crd0,%crd1,%crd2], predicate=%p  : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i32, i32, i32, i1
  return
}

// CHECK-LABEL: @tma_load_4d
func.func @tma_load_4d(%tmaDescriptor: !ptr.ptr, %dest : !ptr.ptr<3>, %barrier: !ptr.ptr<3>, %crd0: i32, %crd1: i32, %crd2: i32, %crd3: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, box[%crd0,%crd1,%crd2,%crd3] : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i32, i32, i32, i32
...
func.func @tma_load_5d(%tmaDescriptor: !ptr.ptr, %dest : !ptr.ptr<3>, %barrier: !ptr.ptr<3>, %crd0: i32, %crd1: i32, %crd2: i32, %crd3: i32, %crd4: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, box[%crd0,%crd1,%crd2,%crd3,%crd4] : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i32, i32, i32, i32, i32
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, box[%crd0,%crd1,%crd2,%crd3,%crd4], predicate=%p  : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i32, i32, i32, i32, i32, i1
  return
}

// CHECK-LABEL: @tma_load_multicast1d
func.func @tma_load_multicast1d(%tmaDescriptor: !ptr.ptr, %dest : !ptr.ptr<3>, %barrier: !ptr.ptr<3>, %multicastMask : i16, %crd0: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, multicast_mask = %multicastMask, box [%crd0] : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i16, i32
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, multicast_mask = %multicastMask, box [%crd0], predicate=%p : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i16, i32,i1
  return
}

// CHECK-LABEL: @tma_load_multicast2d
func.func @tma_load_multicast2d(%tmaDescriptor: !ptr.ptr, %dest : !ptr.ptr<3>, %barrier: !ptr.ptr<3>, %multicastMask : i16, %crd0: i32, %crd1: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, multicast_mask = %multicastMask, box [%crd0,%crd1] : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i16, i32, i32
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, multicast_mask = %multicastMask, box [%crd0,%crd1], predicate=%p  : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i16, i32, i32, i1
  return
}

// CHECK-LABEL: @tma_load_multicast3d
func.func @tma_load_multicast3d(%tmaDescriptor: !ptr.ptr, %dest : !ptr.ptr<3>, %barrier: !ptr.ptr<3>, %multicastMask : i16, %crd0: i32, %crd1: i32, %crd2: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, multicast_mask = %multicastMask, box [%crd0,%crd1,%crd2] : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i16, i32, i32, i32
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, multicast_mask = %multicastMask, box [%crd0,%crd1,%crd2], predicate=%p  : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i16, i32, i32, i32, i1
  return
}

// CHECK-LABEL: @tma_load_multicast4d
func.func @tma_load_multicast4d(%tmaDescriptor: !ptr.ptr, %dest : !ptr.ptr<3>, %barrier: !ptr.ptr<3>, %multicastMask : i16, %crd0: i32, %crd1: i32, %crd2: i32, %crd3: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, multicast_mask = %multicastMask, box [%crd0,%crd1,%crd2,%crd3] : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i16, i32, i32, i32, i32
  // CHECK: llvm.inline_asm has_side_effects asm_dialect = att "@$7 cp.async.bulk.tensor.3d.shared::cluster.global.mbarrier::complete_tx::bytes.multicast::cluster [$0], [$1, {$4, $5, $6} ], [$2], $3;", "r,l,r,h,r,r,r,b"
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, multicast_mask = %multicastMask, box [%crd0,%crd1,%crd2], predicate=%p  : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i16, i32, i32, i32, i1
  return
}
...
func.func @tma_load_multicast5d(%tmaDescriptor: !ptr.ptr, %dest : !ptr.ptr<3>, %barrier: !ptr.ptr<3>, %multicastMask : i16, %crd0: i32, %crd1: i32, %crd2: i32, %crd3: i32, %crd4: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, multicast_mask = %multicastMask, box [%crd0,%crd1,%crd2,%crd3,%crd4] : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i16, i32, i32, i32, i32, i32
  ...
  nvvm.cp.async.bulk.tensor.shared.cluster.global %dest, %tmaDescriptor,  %barrier, multicast_mask = %multicastMask, box [%crd0,%crd1,%crd2,%crd3,%crd4], predicate=%p  : !ptr.ptr<3>, !ptr.ptr, !ptr.ptr<3>, i16, i32, i32, i32, i32, i32, i1
  return
}

// CHECK-LABEL: @tma_store_1d
func.func @tma_store_1d(%tmaDescriptor: !ptr.ptr, %src : !ptr.ptr<3>, %crd0: i32, %p : i1) {
  // CHECK: llvm.inline_asm has_side_effects asm_dialect = att "cp.async.bulk.tensor.1d.global.shared::cta.bulk_group [$0, {$2} ], [$1];", "l,r,r"
  nvvm.cp.async.bulk.tensor.global.shared.cta %tmaDescriptor, %src, box[%crd0] : !ptr.ptr, !ptr.ptr<3>, i32
  ...
  nvvm.cp.async.bulk.tensor.global.shared.cta %tmaDescriptor, %src, box[%crd0], predicate=%p : !ptr.ptr, !ptr.ptr<3>, i32, i1
  return
}

// CHECK-LABEL: @tma_store_2d
func.func @tma_store_2d(%tmaDescriptor: !ptr.ptr, %src : !ptr.ptr<3>, %crd0: i32, %crd1: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.global.shared.cta %tmaDescriptor, %src, box[%crd0,%crd1] : !ptr.ptr, !ptr.ptr<3>, i32, i32
  ...
  nvvm.cp.async.bulk.tensor.global.shared.cta %tmaDescriptor, %src, box[%crd0,%crd1], predicate=%p : !ptr.ptr, !ptr.ptr<3>, i32, i32, i1
  return
}

// CHECK-LABEL: @tma_store_3d
func.func @tma_store_3d(%tmaDescriptor: !ptr.ptr, %src : !ptr.ptr<3>, %crd0: i32, %crd1: i32, %crd2: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.global.shared.cta %tmaDescriptor, %src, box[%crd0,%crd1,%crd2] : !ptr.ptr, !ptr.ptr<3>, i32, i32, i32
  ...
  nvvm.cp.async.bulk.tensor.global.shared.cta %tmaDescriptor, %src, box[%crd0,%crd1,%crd2], predicate=%p : !ptr.ptr, !ptr.ptr<3>, i32, i32, i32, i1
  return
}

// CHECK-LABEL: @tma_store_4d
func.func @tma_store_4d(%tmaDescriptor: !ptr.ptr, %src : !ptr.ptr<3>, %crd0: i32, %crd1: i32, %crd2: i32, %crd3: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.global.shared.cta %tmaDescriptor, %src, box[%crd0,%crd1,%crd2,%crd3] : !ptr.ptr, !ptr.ptr<3>, i32, i32, i32, i32
  ...
  nvvm.cp.async.bulk.tensor.global.shared.cta %tmaDescriptor, %src, box[%crd0,%crd1,%crd2,%crd3], predicate=%p : !ptr.ptr, !ptr.ptr<3>, i32, i32, i32, i32, i1
  return
}

// CHECK-LABEL: @tma_store_5d
func.func @tma_store_5d(%tmaDescriptor: !ptr.ptr, %src : !ptr.ptr<3>, %crd0: i32, %crd1: i32, %crd2: i32, %crd3: i32, %crd4: i32, %p : i1) {
  ...
  nvvm.cp.async.bulk.tensor.global.shared.cta %tmaDescriptor, %src, box[%crd0,%crd1,%crd2,%crd3,%crd4] : !ptr.ptr, !ptr.ptr<3>, i32, i32, i32, i32, i32
  ...
  nvvm.cp.async.bulk.tensor.global.shared.cta %tmaDescriptor, %src, box[%crd0,%crd1,%crd2,%crd3,%crd4], predicate=%p : !ptr.ptr, !ptr.ptr<3>, i32, i32, i32, i32, i32, i1
  return
}
...
// CHECK-SAME: %[[arg0:[a-zA-Z0-9_]+]]: !ptr.ptr<3>, 
// CHECK-SAME: %[[arg1:[a-zA-Z0-9_]+]]: i32,
// CHECK-SAME: %[[arg2:[a-zA-Z0-9_]+]]: i32,
// CHECK-SAME: %[[arg3:[a-zA-Z0-9_]+]]: i32,
// CHECK-SAME: %[[arg4:[a-zA-Z0-9_]+]]: i32)
llvm.func @stmatrix(%arg0 : !ptr.ptr<3>, %m1 : i32, %m2 : i32, %m3 : i32, %m4 : i32) {
// CHECK: llvm.inline_asm has_side_effects asm_dialect = att "stmatrix.sync.aligned.x1.m8n8.shared.b16 [$0], {$1}", "r,r" %[[arg0]], %[[arg1]] : (!ptr.ptr<3>, i32) -> ()
// CHECK: llvm.inline_asm has_side_effects asm_dialect = att "stmatrix.sync.aligned.x2.m8n8.shared.b16 [$0], {$1, $2}", "r,r,r" %[[arg0]], %[[arg1]], %[[arg2]] : (!ptr.ptr<3>, i32, i32) -> ()
// CHECK: llvm.inline_asm has_side_effects asm_dialect = att "stmatrix.sync.aligned.x4.m8n8.shared.b16 [$0], {$1, $2, $3, $4};", "r,r,r,r,r" %[[arg0]], %[[arg1]], %[[arg2]], %[[arg3]], %[[arg4]] : (!ptr.ptr<3>, i32, i32, i32, i32) -> ()
// CHECK: llvm.inline_asm has_side_effects asm_dialect = att "stmatrix.sync.aligned.x1.trans.m8n8.shared.b16 [$0], {$1}", "r,r" %[[arg0]], %[[arg1]] : (!ptr.ptr<3>, i32) -> ()
// CHECK: llvm.inline_asm has_side_effects asm_dialect = att "stmatrix.sync.aligned.x2.trans.m8n8.shared.b16 [$0], {$1, $2}", "r,r,r" %[[arg0]], %[[arg1]], %[[arg2]] : (!ptr.ptr<3>, i32, i32) -> ()
// CHECK: llvm.inline_asm has_side_effects asm_dialect = att "stmatrix.sync.aligned.x4.trans.m8n8.shared.b16 [$0], {$1, $2, $3, $4};", "r,r,r,r,r" %[[arg0]], %[[arg1]], %[[arg2]], %[[arg3]], %[[arg4]] : (!ptr.ptr<3>, i32, i32, i32, i32) -> ()
  nvvm.stmatrix %arg0, %m1 {layout = #nvvm.mma_layout<row>} : !ptr.ptr<3>, i32
  nvvm.stmatrix %arg0, %m1, %m2 {layout = #nvvm.mma_layout<row>} : !ptr.ptr<3>, i32, i32
  nvvm.stmatrix %arg0, %m1, %m2, %m3, %m4 {layout = #nvvm.mma_layout<row>} : !ptr.ptr<3>, i32, i32, i32, i32
  nvvm.stmatrix %arg0, %m1 {layout = #nvvm.mma_layout<col>} : !ptr.ptr<3>, i32
  nvvm.stmatrix %arg0, %m1, %m2 {layout = #nvvm.mma_layout<col>} : !ptr.ptr<3>, i32, i32
  nvvm.stmatrix %arg0, %m1, %m2, %m3, %m4 {layout = #nvvm.mma_layout<col>} : !ptr.ptr<3>, i32, i32, i32, i32
  llvm.return 
}
