...
// CHECK-LABEL: func private @async_execute_fn_0(%arg0: !ptr.ptr, %arg1: f32, %arg2: memref<1xf32>)
// CHECK-SAME: -> !ptr.ptr
// CHECK: %[[RET_1:.*]] = call @mlirAsyncRuntimeCreateToken()
// CHECK: %[[HDL_1:.*]] = llvm.intr.coro.begin
...
// Function outlined from the async.execute operation.
// CHECK: func private @async_execute_fn_0(%arg0: !ptr.ptr)
// CHECK: %[[RET_1:.*]] = call @mlirAsyncRuntimeCreateToken()
// CHECK: %[[HDL_1:.*]] = llvm.intr.coro.begin
...
func.func @execute_and_return_f32() -> f32 {
 // CHECK: %[[RET:.*]]:2 = call @async_execute_fn
  ...
  // CHECK: %[[LOADED:.*]] = llvm.load %[[STORAGE]] : !ptr.ptr -> f32
...
// CHECK: llvm.store %[[CST]], %[[STORAGE]] : f32, !ptr.ptr
...
// CHECK-LABEL: func private @async_execute_fn_0(%arg0: !ptr.ptr)
// CHECK: %[[TOKEN:.*]] = call @mlirAsyncRuntimeCreateToken()
// CHECK: %[[HDL:.*]] = llvm.intr.coro.begin
