...
llvm.func @allocation() -> !ptr.ptr {
  %0 = llvm.mlir.constant(4 : index) : i64
  %1 = llvm.call @malloc(%0) : (i64) -> !ptr.ptr
  llvm.return %1 : !ptr.ptr
}
llvm.func @deallocation(%arg0: !ptr.ptr) {
  llvm.call @free(%arg0) : (!ptr.ptr) -> ()
  llvm.return
}
...
// works.
llvm.func @foo() -> f32 {
  %0 = llvm.call @allocation() : () -> !ptr.ptr
  %1 = llvm.mlir.constant(0 : index) : i64
  %2 = llvm.mlir.constant(1.234000e+03 : f32) : f32
  %3 = llvm.getelementptr %0[%1] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %2, %3 : f32, !ptr.ptr
  %4 = llvm.getelementptr %0[%1] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  %5 = llvm.load %4 : !ptr.ptr -> f32
  llvm.call @deallocation(%0) : (!ptr.ptr) -> ()
  llvm.return %5 : f32
}
// NOMAIN: 1.234000e+03
