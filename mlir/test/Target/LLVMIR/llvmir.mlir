...
llvm.mlir.global internal constant @int_gep() : !ptr.ptr {
  %addr = llvm.mlir.addressof @i32_global : !ptr.ptr
  %_c0 = llvm.mlir.constant(2: i32) :i32
  %gepinit = llvm.getelementptr %addr[%_c0] : (!ptr.ptr, i32) -> !ptr.ptr, i32
  llvm.return %gepinit : !ptr.ptr
}
...
llvm.func @global_refs() {
  ...
  %0 = llvm.mlir.addressof @i32_global : !ptr.ptr
  %1 = llvm.load %0 : !ptr.ptr -> i32

  // Check the contracted form of load from array constants.
  // CHECK: load i8, ptr @string_const
  %2 = llvm.mlir.addressof @string_const : !ptr.ptr
  %c0 = llvm.mlir.constant(0 : index) : i64
  %3 = llvm.getelementptr %2[%c0, %c0] : (!ptr.ptr, i64, i64) -> !ptr.ptr, !llvm.array<6 x i8>
  %4 = llvm.load %3 : !ptr.ptr -> i8
...
// CHECK-NEXT: %{{[0-9]+}} = insertvalue { ptr } undef, ptr %{{[0-9]+}}, 0
  ...
  %5 = llvm.mul %2, %4 : i64
  %6 = llvm.call @malloc(%5) : (i64) -> !ptr.ptr
...
// CHECK-NEXT: %{{[0-9]+}} = insertvalue { ptr } undef, ptr %{{[0-9]+}}, 0
  ...
  %3 = llvm.mul %0, %2 : i64
  %4 = llvm.call @malloc(%3) : (i64) -> !ptr.ptr
...
// CHECK-NEXT: store float 1.000000e+00, ptr %{{[0-9]+}}
  ...
  %14 = llvm.getelementptr %13[%10] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %7, %14 : f32, !ptr.ptr
...
// CHECK-NEXT: %{{[0-9]+}} = load float, ptr %{{[0-9]+}}
  ...
  %23 = llvm.getelementptr %22[%19] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  %24 = llvm.load %23 : !ptr.ptr -> f32
...
// CHECK-NEXT: %{{[0-9]+}} = insertvalue { ptr, i64 } %{{[0-9]+}}, i64 %{{[0-9]+}}, 1
  ...
  %3 = llvm.call @malloc(%2) : (i64) -> !ptr.ptr
...
// CHECK-NEXT: store float 1.000000e+00, ptr %{{[0-9]+}}
  ...
  %13 = llvm.getelementptr %12[%9] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %7, %13 : f32, !ptr.ptr
...
// CHECK-NEXT: %{{[0-9]+}} = load float, ptr %{{[0-9]+}}
  ...
  %21 = llvm.getelementptr %20[%17] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  %22 = llvm.load %21 : !ptr.ptr -> f32
...
// CHECK-NEXT: %{{[0-9]+}} = insertvalue { ptr, i64, i64 } %{{[0-9]+}}, i64 10, 2
  ...
  %8 = llvm.mul %5, %7 : i64
  %9 = llvm.call @malloc(%8) : (i64) -> !ptr.ptr
...
// CHECK-NEXT: store float 4.200000e+01, ptr %{{[0-9]+}}
  ...
  %30 = llvm.getelementptr %29[%28] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %18, %30 : f32, !ptr.ptr
// CHECK-NEXT: %{{[0-9]+}} = extractvalue { ptr, i64, i64 } %{{[0-9]+}}, 1
// CHECK-NEXT: %{{[0-9]+}} = extractvalue { ptr, i64, i64 } %{{[0-9]+}}, 2
// CHECK-NEXT: %{{[0-9]+}} = mul i64 %{{[0-9]+}}, %{{[0-9]+}}
// CHECK-NEXT: %{{[0-9]+}} = add i64 %{{[0-9]+}}, %{{[0-9]+}}
...
// CHECK-NEXT: %{{[0-9]+}} = load float, ptr %{{[0-9]+}}
  ...
  %42 = llvm.getelementptr %41[%40] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  %43 = llvm.load %42 : !ptr.ptr -> f32
// CHECK-NEXT: ret void
  llvm.return
}
...
// CHECK-NEXT: store float 4.200000e+01, ptr %{{[0-9]+}}
  ...
  %5 = llvm.getelementptr %4[%0] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %2, %5 : f32, !ptr.ptr
...
// CHECK-NEXT: store float 4.200000e+01, ptr %{{[0-9]+}}
  ...
  %8 = llvm.getelementptr %7[%0] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %2, %8 : f32, !ptr.ptr
// CHECK-NEXT: %{{[0-9]+}} = extractvalue { ptr, i64 } %{{[0-9]+}}, 1
...
// CHECK-NEXT: store float 4.200000e+01, ptr %{{[0-9]+}}
  ...
  %14 = llvm.getelementptr %13[%12] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  llvm.store %2, %14 : f32, !ptr.ptr
...
// CHECK-NEXT: %{{[0-9]+}} = insertvalue { ptr, i64 } %{{[0-9]+}}, i64 %{{[0-9]+}}, 1
  ...
  %20 = llvm.call @malloc(%19) : (i64) -> !ptr.ptr
...
// CHECK:   extractvalue { ptr, i64, i64 } [[ret2]], 0
  ...
  %20 = llvm.getelementptr %19[%18] : (!ptr.ptr, i64) -> !ptr.ptr, f32
  %21 = llvm.load %20 : !ptr.ptr -> f32
  llvm.return
}
...
// CHECK-LABEL: @gep
llvm.func @gep(%ptr: !ptr.ptr, %idx: i64,
               %ptr2: !ptr.ptr) {
  // CHECK: = getelementptr { i32, { i32, float } }, ptr %{{.*}}, i64 %{{.*}}, i32 1, i32 0
  llvm.getelementptr %ptr[%idx, 1, 0] : (!ptr.ptr, i64) -> !ptr.ptr, !llvm.struct<(i32, struct<(i32, f32)>)>
  // CHECK: = getelementptr inbounds { [10 x float] }, ptr %{{.*}}, i64 %{{.*}}, i32 0, i64 %{{.*}}
  llvm.getelementptr inbounds %ptr2[%idx, 0, %idx] : (!ptr.ptr, i64, i64) -> !ptr.ptr, !llvm.struct<(array<10 x f32>)>
  llvm.return
}
...
// CHECK-NEXT:  call void @body(i64 %0)
  %0 = llvm.mlir.addressof @body : !ptr.ptr
  llvm.call %0(%arg0) : !ptr.ptr, (i64) -> ()
// CHECK-NEXT:  ret void
  llvm.return
}

// CHECK-LABEL: define i32 @indirect_call(ptr addrspace(42) {{%.*}}, float {{%.*}})
llvm.func @indirect_call(%arg0: !ptr.ptr<42>, %arg1: f32) -> i32 {
// CHECK-NEXT:  %3 = call addrspace(42) i32 %0(float %1)
  %0 = llvm.call %arg0(%arg1) : !ptr.ptr<42>, (f32) -> i32
...
llvm.func @llvm_noalias(%arg0: !ptr.ptr {llvm.noalias}) {
  llvm.return
}
...
llvm.func @byrefattr(%arg0: !ptr.ptr {llvm.byref = i32}) {
  llvm.return
}
...
llvm.func @sretattr(%arg0: !ptr.ptr {llvm.sret = i32}) {
  llvm.return
}
...
llvm.func @llvm_align(%arg0: !ptr.ptr {llvm.align = 4}) {
  llvm.return
}
...
llvm.func @inallocaattr(%arg0: !ptr.ptr {llvm.inalloca = i32}) {
  llvm.return
}
...
llvm.func @alignattr_decl(!ptr.ptr {llvm.align = 64 : i64})

// CHECK-LABEL: declare void @dereferenceableattr_decl(ptr dereferenceable(32))
llvm.func @dereferenceableattr_decl(!ptr.ptr {llvm.dereferenceable = 32 : i64})

// CHECK-LABEL: declare void @dereferenceableornullattr_decl(ptr dereferenceable_or_null(32))
llvm.func @dereferenceableornullattr_decl(!ptr.ptr {llvm.dereferenceable_or_null = 32 : i64})

// CHECK-LABEL: declare void @inregattr_decl(ptr inreg)
llvm.func @inregattr_decl(!ptr.ptr {llvm.inreg})

// CHECK-LABEL: declare void @nocaptureattr_decl(ptr nocapture)
llvm.func @nocaptureattr_decl(!ptr.ptr {llvm.nocapture})

// CHECK-LABEL: declare void @nofreeattr_decl(ptr nofree)
llvm.func @nofreeattr_decl(!ptr.ptr {llvm.nofree})

// CHECK-LABEL: declare void @nonnullattr_decl(ptr nonnull)
llvm.func @nonnullattr_decl(!ptr.ptr {llvm.nonnull})

// CHECK-LABEL: declare void @preallocatedattr_decl(ptr preallocated(float))
llvm.func @preallocatedattr_decl(!ptr.ptr {llvm.preallocated = f32})

// CHECK-LABEL: declare ptr @returnedattr_decl(ptr returned)
llvm.func @returnedattr_decl(!ptr.ptr {llvm.returned}) -> !ptr.ptr

// CHECK-LABEL: declare void @alignstackattr_decl(ptr alignstack(32))
llvm.func @alignstackattr_decl(!ptr.ptr {llvm.alignstack = 32 : i64})

// CHECK-LABEL: declare void @writeonlyattr_decl(ptr writeonly)
llvm.func @writeonlyattr_decl(!ptr.ptr {llvm.writeonly})

// CHECK-LABEL: declare align 4 ptr @alignattr_ret_decl()
llvm.func @alignattr_ret_decl() -> (!ptr.ptr {llvm.align = 4})

// CHECK-LABEL: declare noalias ptr @noaliasattr_ret_decl()
llvm.func @noaliasattr_ret_decl() -> (!ptr.ptr {llvm.noalias})

// CHECK-LABEL: declare noundef ptr @noundefattr_ret_decl()
llvm.func @noundefattr_ret_decl() -> (!ptr.ptr {llvm.noundef})
...
llvm.func @nonnullattr_ret_decl() -> (!ptr.ptr {llvm.nonnull})

// CHECK-LABEL: declare dereferenceable(32) ptr @dereferenceableattr_ret_decl()
llvm.func @dereferenceableattr_ret_decl() -> (!ptr.ptr {llvm.dereferenceable = 32 : i64})

// CHECK-LABEL: declare dereferenceable_or_null(16) ptr @dereferenceableornullattr_ret_decl()
llvm.func @dereferenceableornullattr_ret_decl() -> (!ptr.ptr {llvm.dereferenceable_or_null = 16 : i64})

// CHECK-LABEL: declare inreg ptr @inregattr_ret_decl()
llvm.func @inregattr_ret_decl() -> (!ptr.ptr {llvm.inreg})
...
llvm.func @indirect_varargs_call(%arg0 : !ptr.ptr, %arg1 : i32) {
// CHECK:  call void (...) %0(i32 %1)
  llvm.call %arg0(%arg1) vararg(!llvm.func<void (...)>) : !ptr.ptr, (i32) -> ()
  llvm.return
}
...
// CHECK-NEXT: %3 = ptrtoint ptr %2 to i32
  %1 = llvm.inttoptr %arg0 : i32 to !ptr.ptr
  %2 = llvm.ptrtoint %1 : !ptr.ptr to i32
  llvm.return %2 : i32
}
...
llvm.func @addrspace(%arg0 : !ptr.ptr) -> !ptr.ptr<2> {
// CHECK: %2 = addrspacecast ptr %0 to ptr addrspace(2)
  %1 = llvm.addrspacecast %arg0 : !ptr.ptr to !ptr.ptr<2>
  llvm.return %1 : !ptr.ptr<2>
}
...
llvm.func @alloca(%size : i64) {
  ...
  llvm.alloca %size x i32 {alignment = 0} : (i64) -> (!ptr.ptr)
  // CHECK-NEXT: alloca {{.*}} align 8
  llvm.alloca %size x i32 {alignment = 8} : (i64) -> (!ptr.ptr)
  // CHECK-NEXT: alloca {{.*}} addrspace(3)
  llvm.alloca %size x i32 {alignment = 0} : (i64) -> (!ptr.ptr<3>)
  // CHECK-NEXT: alloca inalloca {{.*}} align 4
  llvm.alloca inalloca %size x i32 : (i64) -> !ptr.ptr
  llvm.return
}
...
llvm.func @atomicrmw(
    %f32_ptr : !ptr.ptr, %f32 : f32,
    %i32_ptr : !ptr.ptr, %i32 : i32) {
  // CHECK: atomicrmw fadd ptr %{{.*}}, float %{{.*}} monotonic
  %0 = llvm.atomicrmw fadd %f32_ptr, %f32 monotonic : !ptr.ptr, f32
  // CHECK: atomicrmw fsub ptr %{{.*}}, float %{{.*}} monotonic
  %1 = llvm.atomicrmw fsub %f32_ptr, %f32 monotonic : !ptr.ptr, f32
  // CHECK: atomicrmw fmax ptr %{{.*}}, float %{{.*}} monotonic
  %2 = llvm.atomicrmw fmax %f32_ptr, %f32 monotonic : !ptr.ptr, f32
  // CHECK: atomicrmw fmin ptr %{{.*}}, float %{{.*}} monotonic
  %3 = llvm.atomicrmw fmin %f32_ptr, %f32 monotonic : !ptr.ptr, f32
  // CHECK: atomicrmw xchg ptr %{{.*}}, float %{{.*}} monotonic
  %4 = llvm.atomicrmw xchg %f32_ptr, %f32 monotonic : !ptr.ptr, f32
  // CHECK: atomicrmw add ptr %{{.*}}, i32 %{{.*}} acquire
  %5 = llvm.atomicrmw add %i32_ptr, %i32 acquire : !ptr.ptr, i32
  // CHECK: atomicrmw sub ptr %{{.*}}, i32 %{{.*}} release
  %6 = llvm.atomicrmw sub %i32_ptr, %i32 release : !ptr.ptr, i32
  // CHECK: atomicrmw and ptr %{{.*}}, i32 %{{.*}} acq_rel
  %7 = llvm.atomicrmw _and %i32_ptr, %i32 acq_rel : !ptr.ptr, i32
  // CHECK: atomicrmw nand ptr %{{.*}}, i32 %{{.*}} seq_cst
  %8 = llvm.atomicrmw nand %i32_ptr, %i32 seq_cst : !ptr.ptr, i32
  // CHECK: atomicrmw or ptr %{{.*}}, i32 %{{.*}} monotonic
  %9 = llvm.atomicrmw _or %i32_ptr, %i32 monotonic : !ptr.ptr, i32
  // CHECK: atomicrmw xor ptr %{{.*}}, i32 %{{.*}} monotonic
  %10 = llvm.atomicrmw _xor %i32_ptr, %i32 monotonic : !ptr.ptr, i32
  // CHECK: atomicrmw max ptr %{{.*}}, i32 %{{.*}} monotonic
  %11 = llvm.atomicrmw max %i32_ptr, %i32 monotonic : !ptr.ptr, i32
  // CHECK: atomicrmw min ptr %{{.*}}, i32 %{{.*}} monotonic
  %12 = llvm.atomicrmw min %i32_ptr, %i32 monotonic : !ptr.ptr, i32
  // CHECK: atomicrmw umax ptr %{{.*}}, i32 %{{.*}} monotonic
  %13 = llvm.atomicrmw umax %i32_ptr, %i32 monotonic : !ptr.ptr, i32
  // CHECK: atomicrmw umin ptr %{{.*}}, i32 %{{.*}} monotonic
  %14 = llvm.atomicrmw umin %i32_ptr, %i32 monotonic : !ptr.ptr, i32
  // CHECK: atomicrmw uinc_wrap ptr %{{.*}}, i32 %{{.*}} monotonic
  %15 = llvm.atomicrmw uinc_wrap %i32_ptr, %i32 monotonic : !ptr.ptr, i32
  // CHECK: atomicrmw udec_wrap ptr %{{.*}}, i32 %{{.*}} monotonic
  %16 = llvm.atomicrmw udec_wrap %i32_ptr, %i32 monotonic : !ptr.ptr, i32

  // CHECK: atomicrmw volatile
  // CHECK-SAME:  syncscope("singlethread")
  // CHECK-SAME:  align 8
  %17 = llvm.atomicrmw volatile udec_wrap %i32_ptr, %i32 syncscope("singlethread") monotonic {alignment = 8 : i64} : !ptr.ptr, i32
  llvm.return
}

// CHECK-LABEL: @cmpxchg
llvm.func @cmpxchg(%ptr : !ptr.ptr, %cmp : i32, %val: i32) {
  // CHECK: cmpxchg ptr %{{.*}}, i32 %{{.*}}, i32 %{{.*}} acq_rel monotonic
  %0 = llvm.cmpxchg %ptr, %cmp, %val acq_rel monotonic : !ptr.ptr, i32
  ...
  // CHECK-SAME:  syncscope("singlethread")
  // CHECK-SAME:  align 8
  %3 = llvm.cmpxchg weak volatile %ptr, %cmp, %val syncscope("singlethread") acq_rel monotonic {alignment = 8 : i64} : !ptr.ptr, i32
  llvm.return
}

llvm.mlir.global external constant @_ZTIi() : !ptr.ptr
llvm.func @foo(!ptr.ptr)
llvm.func @vararg_foo(!ptr.ptr, ...)
llvm.func @bar(!ptr.ptr) -> !ptr.ptr
...
// CHECK: %[[a1:[0-9]+]] = alloca i8
  ...
  %2 = llvm.mlir.addressof @_ZTIi : !ptr.ptr
  %4 = llvm.mlir.zero : !ptr.ptr
  %5 = llvm.mlir.constant(1 : i32) : i32
  %6 = llvm.alloca %5 x i8 : (i32) -> !ptr.ptr
// CHECK: invoke void @foo(ptr %[[a1]])
// CHECK-NEXT: to label %[[normal:[0-9]+]] unwind label %[[unwind:[0-9]+]]
  llvm.invoke @foo(%6) to ^bb2 unwind ^bb1 : (!ptr.ptr) -> ()
...
// CHECK-NEXT:             filter [1 x i8] zeroinitializer
  %7 = llvm.landingpad (catch %4 : !ptr.ptr) (catch %2 : !ptr.ptr) (filter %1 : !llvm.array<1 x i8>) : !llvm.struct<(ptr, i32)>
...
^bb3:	// pred: ^bb1
  %8 = llvm.invoke @bar(%6) to ^bb2 unwind ^bb1 : (!ptr.ptr) -> !ptr.ptr

// CHECK: [[BB4:.*]]:
// CHECK: invoke void (ptr, ...) @vararg_foo(ptr %[[a1]], i32 0)
^bb4:
  llvm.invoke @vararg_foo(%6, %0) to ^bb2 unwind ^bb1 vararg(!llvm.func<void (ptr, ...)>) : (!ptr.ptr, i32) -> ()

// CHECK: [[BB5:.*]]:
// CHECK: invoke void (ptr, ...) undef(ptr %[[a1]], i32 0)
^bb5:
  %9 = llvm.mlir.undef : !ptr.ptr
  llvm.invoke %9(%6, %0) to ^bb2 unwind ^bb1 vararg(!llvm.func<void (ptr, ...)>) : !ptr.ptr, (!ptr.ptr, i32) -> ()
}
...
// CHECK-SAME: %[[a0:[0-9]+]]
llvm.func @invoke_result(%arg0 : !ptr.ptr) attributes { personality = @__gxx_personality_v0 } {
...
llvm.mlir.global internal constant @taker_of_address() : !ptr.ptr {
  %0 = llvm.mlir.addressof @address_taken : !ptr.ptr
  llvm.return %0 : !ptr.ptr
}
...
llvm.mlir.global linkonce @forward_use_of_address() : !ptr.ptr {
  %0 = llvm.mlir.addressof @address_declared_after_use : !ptr.ptr
  llvm.return %0 : !ptr.ptr
}
...
llvm.mlir.global linkonce @take_self_address() : !llvm.struct<(i32, !ptr.ptr)> {
  %z32 = llvm.mlir.constant(0 : i32) : i32
  %0 = llvm.mlir.undef : !llvm.struct<(i32, !ptr.ptr)>
  %1 = llvm.mlir.addressof @take_self_address : !ptr.ptr
  %2 = llvm.getelementptr %1[%z32, 0] : (!ptr.ptr, i32) -> !ptr.ptr, !llvm.struct<(i32, !ptr.ptr)>
  %3 = llvm.insertvalue %z32, %0[0] : !llvm.struct<(i32, !ptr.ptr)>
  %4 = llvm.insertvalue %2, %3[1] : !llvm.struct<(i32, !ptr.ptr)>
  llvm.return %4 : !llvm.struct<(i32, !ptr.ptr)>
}
...
llvm.func @volatile_store_and_load() {
  ...
  %0 = llvm.alloca %size x i32 : (i64) -> (!ptr.ptr)
  // CHECK: store volatile i32 5, ptr %{{.*}}
  llvm.store volatile %val, %0 : i32, !ptr.ptr
  // CHECK: %{{.*}} = load volatile i32, ptr %{{.*}}
  %1 = llvm.load volatile %0: !ptr.ptr -> i32
  llvm.return
}
...
llvm.func @nontemporal_store_and_load() {
  ...
  llvm.store %val, %0 {nontemporal} : i32, !ptr.ptr
  // CHECK: !nontemporal ![[NODE]]
  %1 = llvm.load %0 {nontemporal} : !ptr.ptr -> i32
  llvm.return
}
...
llvm.func @atomic_store_and_load(%ptr : !ptr.ptr) {
  // CHECK: load atomic
  // CHECK-SAME:  acquire, align 4
  %1 = llvm.load %ptr atomic acquire {alignment = 4 : i64} : !ptr.ptr -> f32
  // CHECK: load atomic
  // CHECK-SAME:  syncscope("singlethread") acquire, align 4
  %2 = llvm.load %ptr atomic syncscope("singlethread") acquire {alignment = 4 : i64} : !ptr.ptr -> f32

  // CHECK: store atomic
  // CHECK-SAME:  release, align 4
  llvm.store %1, %ptr atomic release {alignment = 4 : i64} : f32, !ptr.ptr
  // CHECK: store atomic
  // CHECK-SAME:  syncscope("singlethread") release, align 4
  llvm.store %2, %ptr atomic syncscope("singlethread") release {alignment = 4 : i64} : f32, !ptr.ptr
  llvm.return
}
...
llvm.func @vararg_function(%arg0: i32, ...) {
  ...
  %2 = llvm.alloca %1 x !llvm.struct<"struct.va_list", (ptr)> {alignment = 8 : i64} : (i32) -> !ptr.ptr
  // CHECK: call void @llvm.va_start(ptr %[[ALLOCA0]])
  llvm.intr.vastart %2 : !ptr.ptr
  // CHECK: %[[ALLOCA1:.+]] = alloca ptr, align 8
  %4 = llvm.alloca %0 x !ptr.ptr {alignment = 8 : i64} : (i32) -> !ptr.ptr
  // CHECK: call void @llvm.va_copy(ptr %[[ALLOCA1]], ptr %[[ALLOCA0]])
  llvm.intr.vacopy %2 to %4 : !ptr.ptr, !ptr.ptr
  // CHECK: call void @llvm.va_end(ptr %[[ALLOCA1]])
  // CHECK: call void @llvm.va_end(ptr %[[ALLOCA0]])
  llvm.intr.vaend %4 : !ptr.ptr
  llvm.intr.vaend %2 : !ptr.ptr
  // CHECK: ret void
  llvm.return
}
...
llvm.func @readonly_function(%arg0: !ptr.ptr {llvm.readonly})
...
llvm.func @zeroinit_complex_local_aggregate() {
  ...
  %1 = llvm.alloca %0 x !llvm.array<1000 x !llvm.struct<(i32, !llvm.array<3 x !llvm.struct<(f64, !llvm.vec<4 x ptr>, !llvm.array<2 x ptr>)>>, !llvm.array<6 x ptr>)>> : (i64) -> !ptr.ptr
  ...
  llvm.store %2, %1 : !llvm.array<1000 x !llvm.struct<(i32, !llvm.array<3 x !llvm.struct<(f64, !llvm.vec<4 x ptr>, !llvm.array<2 x ptr>)>>, !llvm.array<6 x ptr>)>>, !ptr.ptr
