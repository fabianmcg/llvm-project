...
// in the region.
llvm.func @omp_atomic_update_multiple_step_update(%x: !ptr.ptr, %expr: i32) {
...
llvm.func @omp_atomic_update_multiple_step_update(%x: !ptr.ptr, %v: !ptr.ptr, %expr: i32) {
...
llvm.func @omp_threadprivate() {
  ...
  %4 = llvm.alloca %0 x i32 {in_type = i32, name = "a"} : (i64) -> !ptr.ptr
  ...
  %5 = omp.threadprivate %4 : !ptr.ptr -> !ptr.ptr

  llvm.store %1, %5 : i32, !ptr.ptr

  omp.parallel  {
    %6 = omp.threadprivate %4 : !ptr.ptr -> !ptr.ptr
    llvm.store %2, %6 : i32, !ptr.ptr
    omp.terminator
  }

  llvm.store %3, %5 : i32, !ptr.ptr
  llvm.return
}
