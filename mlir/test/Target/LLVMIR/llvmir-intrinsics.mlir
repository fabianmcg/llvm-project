...
llvm.func @intrinsics(%arg0: f32, %arg1: f32, %arg2: vector<8xf32>, %arg3: !ptr.ptr) {
  ...
  "llvm.intr.prefetch"(%arg3) <{cache = 1 : i32, hint = 3 : i32, rw = 0 : i32}> : (!ptr.ptr) -> ()
  llvm.return
}
...
llvm.func @masked_load_store_intrinsics(%A: !ptr.ptr, %mask: vector<7xi1>) {
...
llvm.func @masked_expand_compress_intrinsics(%ptr: !ptr.ptr, %mask: vector<7xi1>, %passthru: vector<7xf32>) {
  ...
  "llvm.intr.masked.compressstore"(%0, %ptr, %mask)
    : (vector<7xf32>, !ptr.ptr, vector<7xi1>) -> ()
  llvm.return
}

// CHECK-LABEL: @annotate_intrinsics
llvm.func @annotate_intrinsics(%var: !ptr.ptr, %int: i16, %ptr: !ptr.ptr, %annotation: !ptr.ptr, %fileName: !ptr.ptr, %line: i32, %attr: !ptr.ptr) {
  // CHECK: call void @llvm.var.annotation.p0.p0(ptr %{{.*}}, ptr %{{.*}}, ptr %{{.*}}, i32 %{{.*}}, ptr %{{.*}})
  "llvm.intr.var.annotation"(%var, %annotation, %fileName, %line, %attr) : (!ptr.ptr, !ptr.ptr, !ptr.ptr, i32, !ptr.ptr) -> ()
  // CHECK: call ptr @llvm.ptr.annotation.p0.p0(ptr %{{.*}}, ptr %{{.*}}, ptr %{{.*}}, i32 %{{.*}}, ptr %{{.*}})
  %res0 = "llvm.intr.ptr.annotation"(%ptr, %annotation, %fileName, %line, %attr) : (!ptr.ptr, !ptr.ptr, !ptr.ptr, i32, !ptr.ptr) -> (!ptr.ptr)
  // CHECK: call i16 @llvm.annotation.i16.p0(i16 %{{.*}}, ptr %{{.*}}, ptr %{{.*}}, i32 %{{.*}})
  %res1 = "llvm.intr.annotation"(%int, %annotation, %fileName, %line) : (i16, !ptr.ptr, !ptr.ptr, i32) -> (i16)
  llvm.return
}
...
llvm.func @memcpy_test(%arg0: i32, %arg2: !ptr.ptr, %arg3: !ptr.ptr) {
  ...
  "llvm.intr.memcpy.inline"(%arg2, %arg3) <{isVolatile = true, len = 10 : i32}> : (!ptr.ptr, !ptr.ptr) -> ()
  // CHECK: call void @llvm.memcpy.inline.p0.p0.i64(ptr %{{.*}}, ptr %{{.*}}, i64 10, i1 true
  "llvm.intr.memcpy.inline"(%arg2, %arg3) <{isVolatile = true, len = 10 : i64}> : (!ptr.ptr, !ptr.ptr) -> ()
  llvm.return
}

// CHECK-LABEL: @memmove_test
llvm.func @memmove_test(%arg0: i32, %arg2: !ptr.ptr, %arg3: !ptr.ptr) {
  // CHECK: call void @llvm.memmove.p0.p0.i32(ptr %{{.*}}, ptr %{{.*}}, i32 %{{.*}}, i1 false
  "llvm.intr.memmove"(%arg2, %arg3, %arg0) <{isVolatile = false}> : (!ptr.ptr, !ptr.ptr, i32) -> ()
  llvm.return
}

// CHECK-LABEL: @memset_test
llvm.func @memset_test(%arg0: i32, %arg2: !ptr.ptr, %arg3: i8) {
  %i1 = llvm.mlir.constant(false) : i1
  // CHECK: call void @llvm.memset.p0.i32(ptr %{{.*}}, i8 %{{.*}}, i32 %{{.*}}, i1 false
  "llvm.intr.memset"(%arg2, %arg3, %arg0) <{isVolatile = false}> : (!ptr.ptr, i8, i32) -> ()
  llvm.return
}
...
llvm.func @threadlocal_test(%arg0 : !ptr.ptr) {
  // CHECK: call ptr @llvm.threadlocal.address.p0(ptr %{{.*}})
  "llvm.intr.threadlocal.address"(%arg0) : (!ptr.ptr) -> !ptr.ptr
  llvm.return
}
...
// CHECK-LABEL: @coro_id
llvm.func @coro_id(%arg0: i32, %arg1: !ptr.ptr) {
  // CHECK: call token @llvm.coro.id
  %null = llvm.mlir.zero : !ptr.ptr
  llvm.intr.coro.id %arg0, %arg1, %arg1, %null : (i32, !ptr.ptr, !ptr.ptr, !ptr.ptr) -> !llvm.token
  llvm.return
}

// CHECK-LABEL: @coro_begin
llvm.func @coro_begin(%arg0: i32, %arg1: !ptr.ptr) {
  %null = llvm.mlir.zero : !ptr.ptr
  %token = llvm.intr.coro.id %arg0, %arg1, %arg1, %null : (i32, !ptr.ptr, !ptr.ptr, !ptr.ptr) -> !llvm.token
  // CHECK: call ptr @llvm.coro.begin
  llvm.intr.coro.begin %token, %arg1 : (!llvm.token, !ptr.ptr) -> !ptr.ptr
  llvm.return
}
...
llvm.func @coro_save(%arg0: !ptr.ptr) {
  // CHECK: call token @llvm.coro.save
  %0 = llvm.intr.coro.save %arg0 : (!ptr.ptr) -> !llvm.token
  llvm.return
}

// CHECK-LABEL: @coro_suspend
llvm.func @coro_suspend(%arg0: i32, %arg1 : i1, %arg2 : !ptr.ptr) {
  %null = llvm.mlir.zero : !ptr.ptr
  %token = llvm.intr.coro.id %arg0, %arg2, %arg2, %null : (i32, !ptr.ptr, !ptr.ptr, !ptr.ptr) -> !llvm.token
...
llvm.func @coro_end(%arg0: !ptr.ptr, %arg1 : i1) {
  %none = llvm.mlir.none : !llvm.token
  // CHECK: call i1 @llvm.coro.end
  %0 = llvm.intr.coro.end %arg0, %arg1, %none : (!ptr.ptr, i1, !llvm.token) -> i1
  llvm.return
}

// CHECK-LABEL: @coro_free
llvm.func @coro_free(%arg0: i32, %arg1 : !ptr.ptr) {
  %null = llvm.mlir.zero : !ptr.ptr
  %token = llvm.intr.coro.id %arg0, %arg1, %arg1, %null : (i32, !ptr.ptr, !ptr.ptr, !ptr.ptr) -> !llvm.token
  // CHECK: call ptr @llvm.coro.free
  %0 = llvm.intr.coro.free %token, %arg1 : (!llvm.token, !ptr.ptr) -> !ptr.ptr
  llvm.return
}

// CHECK-LABEL: @coro_resume
llvm.func @coro_resume(%arg0: !ptr.ptr) {
  // CHECK: call void @llvm.coro.resume
  llvm.intr.coro.resume %arg0 : !ptr.ptr
  llvm.return
}

// CHECK-LABEL: @eh_typeid_for
llvm.func @eh_typeid_for(%arg0 : !ptr.ptr) {
...
llvm.func @stack_save() {
  ...
  %0 = llvm.intr.stacksave : !ptr.ptr
  // CHECK: call ptr addrspace(1) @llvm.stacksave.p1
  %1 = llvm.intr.stacksave : !ptr.ptr<1>
  llvm.return
}

// CHECK-LABEL: @stack_restore
llvm.func @stack_restore(%arg0: !ptr.ptr, %arg1: !ptr.ptr<1>) {
  ...
  llvm.intr.stackrestore %arg1 : !ptr.ptr<1>
  llvm.return
}
...
llvm.func @vector_predication_intrinsics(%A: vector<8xi32>, %B: vector<8xi32>,
  ...
  "llvm.intr.vp.ptrtoint" (%G, %mask, %evl) :
         (!llvm.vec<8 x !ptr.ptr>, vector<8xi1>, i32) -> vector<8xi64>
  // CHECK: call <8 x ptr> @llvm.vp.inttoptr.v8p0.v8i64
  "llvm.intr.vp.inttoptr" (%E, %mask, %evl) :
         (vector<8xi64>, vector<8xi1>, i32) -> !llvm.vec<8 x !ptr.ptr>
  llvm.return
}
