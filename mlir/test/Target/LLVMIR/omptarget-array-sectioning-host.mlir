...
module attributes {omp.is_target_device = false} {
  llvm.func @_3d_target_array_section() {
    %0 = llvm.mlir.addressof @_QFEinarray : !ptr.ptr
    %1 = llvm.mlir.addressof @_QFEoutarray : !ptr.ptr
    ...
    %7 = omp.map_info var_ptr(%0 : !ptr.ptr, !llvm.array<3 x array<3 x array<3 x i32>>>)   map_clauses(tofrom) capture(ByRef) bounds(%5, %5, %6) -> !ptr.ptr {name = "inarray(1:3,1:3,2:2)"}
    %8 = omp.map_info var_ptr(%1 : !ptr.ptr, !llvm.array<3 x array<3 x array<3 x i32>>>)   map_clauses(tofrom) capture(ByRef) bounds(%5, %5, %5) -> !ptr.ptr {name = "outarray(1:3,1:3,1:3)"}
    omp.target   map_entries(%7 -> %arg0, %8 -> %arg1 : !ptr.ptr, !ptr.ptr) {
      ^bb0(%arg0: !ptr.ptr, %arg1: !ptr.ptr):
      %9 = llvm.mlir.constant(0 : i64) : i64
      %10 = llvm.mlir.constant(1 : i64) : i64
      %11 = llvm.getelementptr %arg0[0, %10, %9, %9] : (!ptr.ptr, i64, i64, i64) -> !ptr.ptr, !llvm.array<3 x array<3 x array<3 x i32>>>
      %12 = llvm.load %11 : !ptr.ptr -> i32
      %13 = llvm.getelementptr %arg1[0, %10, %9, %9] : (!ptr.ptr, i64, i64, i64) -> !ptr.ptr, !llvm.array<3 x array<3 x array<3 x i32>>>
      llvm.store %12, %13 : i32, !ptr.ptr
      omp.terminator
    }
    llvm.return
  }
