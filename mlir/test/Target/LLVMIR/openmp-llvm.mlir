...
llvm.func @test_flush_construct(%arg0: !ptr.ptr) {
  // CHECK: call void @__kmpc_flush(ptr @{{[0-9]+}}
  omp.flush

  // CHECK: call void @__kmpc_flush(ptr @{{[0-9]+}}
  omp.flush (%arg0 : !ptr.ptr)

  // CHECK: call void @__kmpc_flush(ptr @{{[0-9]+}}
  omp.flush (%arg0, %arg0 : !ptr.ptr, !ptr.ptr)

  %0 = llvm.mlir.constant(1 : i64) : i64
  //  CHECK: alloca {{.*}} align 4
  %1 = llvm.alloca %0 x i32 {in_type = i32, name = "a"} : (i64) -> !ptr.ptr
  // CHECK: call void @__kmpc_flush(ptr @{{[0-9]+}}
  omp.flush
  //  CHECK: load i32, ptr
...
llvm.func @wsloop_simple(%arg0: !ptr.ptr) {
  ...
  omp.parallel {
    ...
    ^bb0(%arg1: i64):
      ...
      %4 = llvm.getelementptr %arg0[%arg1] : (!ptr.ptr, i64) -> !ptr.ptr, f32
      llvm.store %3, %4 : f32, !ptr.ptr
      omp.yield
...
llvm.func @wsloop_inclusive_1(%arg0: !ptr.ptr) {
  %0 = llvm.mlir.constant(42 : index) : i64
  %1 = llvm.mlir.constant(10 : index) : i64
  %2 = llvm.mlir.constant(1 : index) : i64
...
llvm.func @wsloop_inclusive_2(%arg0: !ptr.ptr) {
  %0 = llvm.mlir.constant(42 : index) : i64
  %1 = llvm.mlir.constant(10 : index) : i64
  %2 = llvm.mlir.constant(1 : index) : i64
...
llvm.func @test_omp_wsloop_dynamic_chunk_var(%lb : i32, %ub : i32, %step : i32) -> () {
 ...
 %chunk_size_alloca = llvm.alloca %1 x i16 {bindc_name = "chunk_size", in_type = i16, uniq_name = "_QFsub1Echunk_size"} : (i64) -> !ptr.ptr
 %chunk_size_var = llvm.load %chunk_size_alloca : !ptr.ptr -> i16
...
llvm.func @test_omp_wsloop_dynamic_chunk_var2(%lb : i32, %ub : i32, %step : i32) -> () {
 %1 = llvm.mlir.constant(1 : i64) : i64
 %chunk_size_alloca = llvm.alloca %1 x i64 {bindc_name = "chunk_size", in_type = i64, uniq_name = "_QFsub1Echunk_size"} : (i64) -> !ptr.ptr
 %chunk_size_var = llvm.load %chunk_size_alloca : !ptr.ptr -> i64
...
llvm.func @simdloop_simple(%lb : i64, %ub : i64, %step : i64, %arg0: !ptr.ptr) {
  "omp.simdloop" (%lb, %ub, %step) ({
    ^bb0(%iv: i64):
      ...
      %4 = llvm.getelementptr %arg0[%iv] : (!ptr.ptr, i64) -> !ptr.ptr, f32
      llvm.store %3, %4 : f32, !ptr.ptr
      omp.yield
...
llvm.func @simdloop_simple_multiple(%lb1 : i64, %ub1 : i64, %step1 : i64, %lb2 : i64, %ub2 : i64, %step2 : i64, %arg0: !ptr.ptr, %arg1: !ptr.ptr) {
  omp.simdloop for (%iv1, %iv2) : i64 = (%lb1, %lb2) to (%ub1, %ub2) step (%step1, %step2) {
    ...
    %4 = llvm.getelementptr %arg0[%iv1] : (!ptr.ptr, i64) -> !ptr.ptr, f32
    %5 = llvm.getelementptr %arg1[%iv2] : (!ptr.ptr, i64) -> !ptr.ptr, f32
    llvm.store %3, %4 : f32, !ptr.ptr
    llvm.store %3, %5 : f32, !ptr.ptr
    omp.yield
  }
  llvm.return
}
...
llvm.func @simdloop_simple_multiple_simdlen(%lb1 : i64, %ub1 : i64, %step1 : i64, %lb2 : i64, %ub2 : i64, %step2 : i64, %arg0: !ptr.ptr, %arg1: !ptr.ptr) {
...
llvm.func @simdloop_simple_multiple_safelen(%lb1 : i64, %ub1 : i64, %step1 : i64, %lb2 : i64, %ub2 : i64, %step2 : i64, %arg0: !ptr.ptr, %arg1: !ptr.ptr) {
...
llvm.func @simdloop_simple_multiple_simdlen_safelen(%lb1 : i64, %ub1 : i64, %step1 : i64, %lb2 : i64, %ub2 : i64, %step2 : i64, %arg0: !ptr.ptr, %arg1: !ptr.ptr) {
...
llvm.func @simdloop_if(%arg0: !ptr.ptr {fir.bindc_name = "n"}, %arg1: !ptr.ptr {fir.bindc_name = "threshold"}) {
  %0 = llvm.mlir.constant(1 : i64) : i64
  %1 = llvm.alloca %0 x i32 {adapt.valuebyref, in_type = i32, operandSegmentSizes = array<i32: 0, 0>} : (i64) -> !ptr.ptr
  %2 = llvm.mlir.constant(1 : i64) : i64
  %3 = llvm.alloca %2 x i32 {bindc_name = "i", in_type = i32, operandSegmentSizes = array<i32: 0, 0>, uniq_name = "_QFtest_simdEi"} : (i64) -> !ptr.ptr
  %4 = llvm.mlir.constant(0 : i32) : i32
  %5 = llvm.load %arg0 : !ptr.ptr -> i32
  %6 = llvm.mlir.constant(1 : i32) : i32
  %7 = llvm.load %arg0 : !ptr.ptr -> i32
  %8 = llvm.load %arg1 : !ptr.ptr -> i32
  %9 = llvm.icmp "sge" %7, %8 : i32
  omp.simdloop   if(%9) for  (%arg2) : i32 = (%4) to (%5) inclusive step (%6) {
    // The form of the emitted IR is controlled by OpenMPIRBuilder and
    // tested there. Just check that the right metadata is added.
    // CHECK: llvm.access.group
    llvm.store %arg2, %1 : i32, !ptr.ptr
    omp.yield
  }
  llvm.return
}
...
llvm.func @omp_atomic_write(%x: !ptr.ptr, %expr: i32) -> () {
  // CHECK: store atomic i32 %[[expr]], ptr %[[x]] monotonic, align 4
  omp.atomic.write %x = %expr : !ptr.ptr, i32
  // CHECK: store atomic i32 %[[expr]], ptr %[[x]] seq_cst, align 4
  // CHECK: call void @__kmpc_flush(ptr @{{.*}})
  omp.atomic.write %x = %expr memory_order(seq_cst) : !ptr.ptr, i32
  // CHECK: store atomic i32 %[[expr]], ptr %[[x]] release, align 4
  // CHECK: call void @__kmpc_flush(ptr @{{.*}})
  omp.atomic.write %x = %expr memory_order(release) : !ptr.ptr, i32
  // CHECK: store atomic i32 %[[expr]], ptr %[[x]] monotonic, align 4
  omp.atomic.write %x = %expr memory_order(relaxed) : !ptr.ptr, i32
  llvm.return
}
...
// CHECK-SAME: (ptr %[[x:.*]], i32 %[[expr:.*]])
llvm.func @omp_atomic_update_ordering(%x:!ptr.ptr, %expr: i32) {
...
// CHECK-SAME: (ptr %[[x:.*]], i32 %[[expr:.*]])
llvm.func @omp_atomic_update_intrinsic(%x:!ptr.ptr, %expr: i32) {
...
llvm.func @omp_atomic_capture_prefix_update(
  %x: !ptr.ptr, %v: !ptr.ptr, %expr: i32,
  %xf: !ptr.ptr, %vf: !ptr.ptr, %exprf: f32) -> () {
  ...
  omp.atomic.capture {
    ...
    omp.atomic.read %v = %x : !ptr.ptr, i32
  }
  ...
  omp.atomic.capture {
    omp.atomic.update %xf : !ptr.ptr {
    ^bb0(%xval: f32):
      %newval = llvm.fadd %xval, %exprf : f32
      omp.yield(%newval : f32)
    }
    omp.atomic.read %vf = %xf : !ptr.ptr, f32
  }
...
llvm.func @omp_atomic_capture_misc(
  ...
  omp.atomic.capture{
    omp.atomic.read %vf = %xf : !ptr.ptr, f32
    omp.atomic.write %xf = %exprf : !ptr.ptr, f32
  }
...
llvm.func @omp_sections(%arg0 : i32, %arg1 : i32, %arg2 : !ptr.ptr) -> () {
  ...
  omp.sections {
    ...
    omp.section {
      ...
      // CHECK:   br label %{{.*}}
      llvm.store %add, %arg2 : i32, !ptr.ptr
      omp.terminator
    }
    omp.terminator
  }
...
llvm.func @single(%x: i32, %y: i32, %zaddr: !ptr.ptr) {
  // CHECK: %[[a:.*]] = sub i32 %[[x]], %[[y]]
  %a = llvm.sub %x, %y : i32
  // CHECK: store i32 %[[a]], ptr %[[zaddr]]
  llvm.store %a, %zaddr : i32, !ptr.ptr
  // CHECK: call i32 @__kmpc_single
  omp.single {
    // CHECK: %[[z:.*]] = add i32 %[[x]], %[[y]]
    %z = llvm.add %x, %y : i32
    // CHECK: store i32 %[[z]], ptr %[[zaddr]]
    llvm.store %z, %zaddr : i32, !ptr.ptr
  ...
  llvm.store %b, %zaddr : i32, !ptr.ptr
  // CHECK: ret void
  llvm.return
}
...
// CHECK-SAME: (i32 %[[x:.*]], i32 %[[y:.*]], ptr %[[zaddr:.*]])
llvm.func @single_nowait(%x: i32, %y: i32, %zaddr: !ptr.ptr) {
  // CHECK: %[[a:.*]] = sub i32 %[[x]], %[[y]]
  %a = llvm.sub %x, %y : i32
  // CHECK: store i32 %[[a]], ptr %[[zaddr]]
  llvm.store %a, %zaddr : i32, !ptr.ptr
  ...
  llvm.store %t, %zaddr : i32, !ptr.ptr
  // CHECK: ret void
  llvm.return
}
...
// CHECK:  store i32 2, ptr [[TMP3]], align 4
  ...
  %3 = llvm.mlir.addressof @_QFsubEx : !ptr.ptr
  %4 = omp.threadprivate %3 : !ptr.ptr -> !ptr.ptr

  llvm.store %0, %4 : i32, !ptr.ptr

  omp.parallel  {
    %5 = omp.threadprivate %3 : !ptr.ptr -> !ptr.ptr
    llvm.store %1, %5 : i32, !ptr.ptr
    omp.terminator
  }

  llvm.store %2, %4 : i32, !ptr.ptr
  llvm.return
}
...
// CHECK-SAME: (i32 %[[x:.+]], i32 %[[y:.+]], ptr %[[zaddr:.+]])
llvm.func @omp_task(%x: i32, %y: i32, %zaddr: !ptr.ptr) {
  ...
  omp.task {
    ...
    %valaddr = llvm.alloca %n x i32 : (i64) -> !ptr.ptr
    %val = llvm.load %valaddr : !ptr.ptr -> i32
    %double = llvm.add %val, %val : i32
    llvm.store %double, %valaddr : i32, !ptr.ptr
    omp.terminator
  }
  llvm.return
}
...
llvm.func @omp_task_with_deps(%zaddr: !ptr.ptr) {
  // CHECK: %[[omp_global_thread_num:.+]] = call i32 @__kmpc_global_thread_num({{.+}})
  // CHECK: %[[task_data:.+]] = call ptr @__kmpc_omp_task_alloc
  // CHECK-SAME: (ptr @{{.+}}, i32 %[[omp_global_thread_num]], i32 1, i64 40,
  // CHECK-SAME:  i64 0, ptr @[[outlined_fn:.+]])
  // CHECK: call i32 @__kmpc_omp_task_with_deps(ptr @{{.+}}, i32 %[[omp_global_thread_num]], ptr %[[task_data]], {{.*}})
  omp.task depend(taskdependin -> %zaddr : !ptr.ptr) {
    %n = llvm.mlir.constant(1 : i64) : i64
    %valaddr = llvm.alloca %n x i32 : (i64) -> !ptr.ptr
    %val = llvm.load %valaddr : !ptr.ptr -> i32
    %double = llvm.add %val, %val : i32
...
module attributes {llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  llvm.func @omp_task(%x: i32, %y: i32, %zaddr: !ptr.ptr) {
    ...
    llvm.store %diff, %zaddr : i32, !ptr.ptr
    // CHECK: %[[omp_global_thread_num:.+]] = call i32 @__kmpc_global_thread_num({{.+}})
    // CHECK: %[[task_data:.+]] = call ptr @__kmpc_omp_task_alloc
...
llvm.func @par_task_(%arg0: !ptr.ptr {fir.bindc_name = "a"}) {
  %0 = llvm.mlir.constant(1 : i32) : i32
  omp.task   {
    omp.parallel   {
      llvm.store %0, %arg0 : i32, !ptr.ptr
      omp.terminator
    }
    omp.terminator
  }
...
llvm.func @omp_taskgroup(%x: i32, %y: i32, %zaddr: !ptr.ptr) {
  omp.taskgroup {
    llvm.call @foo() : () -> ()
    omp.terminator
  }
...
llvm.func @foo() -> ()
llvm.func @bar(i32, i32, !ptr.ptr) -> ()

llvm.func @omp_taskgroup_task(%x: i32, %y: i32, %zaddr: !ptr.ptr) {
  omp.taskgroup {
    %c1 = llvm.mlir.constant(1) : i32
    %ptr1 = llvm.alloca %c1 x i8 : (i32) -> !ptr.ptr
    omp.task {
      llvm.call @foo() : () -> ()
      omp.terminator
    }
    omp.task {
      llvm.call @bar(%x, %y, %zaddr) : (i32, i32, !ptr.ptr) -> ()
      omp.terminator
    }
    llvm.br ^bb1
  ^bb1:
...
llvm.func @omp_opaque_pointers(%arg0 : !ptr.ptr, %arg1: !ptr.ptr, %expr: i32) -> () {
  // CHECK: %[[X1:.*]] = load atomic i32, ptr %[[ARG0]] monotonic, align 4
  // CHECK: store i32 %[[X1]], ptr %[[ARG1]], align 4
  omp.atomic.read %arg1 = %arg0 : !ptr.ptr, i32
  ...
  omp.atomic.capture memory_order(acq_rel) {
    omp.atomic.read %arg0 = %arg1 : !ptr.ptr, i32
    omp.atomic.update %arg1 : !ptr.ptr {
    ^bb0(%xval: i32):
      %newval = llvm.add %xval, %expr : i32
      omp.yield(%newval : i32)
    }
