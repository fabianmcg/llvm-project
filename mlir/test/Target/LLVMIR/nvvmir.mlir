...
llvm.func @gpu_wmma_load_op(%arg0: !ptr.ptr<3>, %arg1: i32) {
  ...
  %0 = nvvm.wmma.load %arg0, %arg1
    ...
    : (!ptr.ptr<3>) -> !llvm.struct<(vector<2xf16>, vector<2xf16>, vector<2xf16>, vector<2xf16>, vector<2xf16>, vector<2xf16>, vector<2xf16>, vector<2xf16>)>
...
llvm.func @gpu_wmma_store_op(%arg0: !ptr.ptr<3>, %arg1: i32,
  ...
  nvvm.wmma.store %arg0, %arg1, %arg2, %arg3, %arg4, %arg5
    ...
    : !ptr.ptr<3>, vector<2 x f16>, vector<2 x f16>, vector<2 x f16>, vector<2 x f16>
  llvm.return
}
...
llvm.func @nvvm_wmma_load_tf32(%arg0: !ptr.ptr, %arg1 : i32) {
...
// CHECK: call void @llvm.nvvm.cp.async.ca.shared.global.4(ptr addrspace(3) %{{.*}}, ptr addrspace(1) %{{.*}})
  nvvm.cp.async.shared.global %arg0, %arg1, 4, cache =  ca : !ptr.ptr<3>, !ptr.ptr<1>
// CHECK: call void @llvm.nvvm.cp.async.ca.shared.global.8(ptr addrspace(3) %{{.*}}, ptr addrspace(1) %{{.*}})
  nvvm.cp.async.shared.global %arg0, %arg1, 8, cache =  ca : !ptr.ptr<3>, !ptr.ptr<1>
...
llvm.func @ld_matrix(%arg0: !ptr.ptr<3>) {
  ...
  %l1t = nvvm.ldmatrix %arg0 {num = 1 : i32, layout = #nvvm.mma_layout<col>} : (!ptr.ptr<3>) -> i32
  // CHECK: call { i32, i32 } @llvm.nvvm.ldmatrix.sync.aligned.m8n8.x2.trans.b16.p3(ptr addrspace(3) %{{.*}})
  %l2t = nvvm.ldmatrix %arg0 {num = 2 : i32, layout = #nvvm.mma_layout<col>} : (!ptr.ptr<3>) -> !llvm.struct<(i32, i32)>
  // CHECK: call { i32, i32, i32, i32 } @llvm.nvvm.ldmatrix.sync.aligned.m8n8.x4.trans.b16.p3(ptr addrspace(3) %{{.*}})
  %l4t = nvvm.ldmatrix %arg0 {num = 4 : i32, layout = #nvvm.mma_layout<col>} : (!ptr.ptr<3>) -> !llvm.struct<(i32, i32, i32, i32)>
  llvm.return
}
