...
llvm.func @my_alloca_fn() -> !ptr.ptr
llvm.func @foo(i32, f32, !ptr.ptr, f128, !ptr.ptr, i32) -> ()
llvm.func @bar()
...
// CHECK: call void @bar()
// CHECK: ret void
llvm.func @omp_teams_branching_shared(%condition: i1, %arg0: i32, %arg1: f32, %arg2: !ptr.ptr, %arg3: f128) {
    %allocated = llvm.call @my_alloca_fn(): () -> !ptr.ptr
    %loaded = llvm.load %allocated : !ptr.ptr -> i32
    llvm.br ^codegenBlock
^codegenBlock:
    omp.teams {
        llvm.cond_br %condition, ^true_block, ^false_block
    ^true_block:
        llvm.call @foo(%arg0, %arg1, %arg2, %arg3, %allocated, %loaded) : (i32, f32, !ptr.ptr, f128, !ptr.ptr, i32) -> ()
        llvm.br ^exit
    ^false_block:
        llvm.br ^exit
    ^exit:
