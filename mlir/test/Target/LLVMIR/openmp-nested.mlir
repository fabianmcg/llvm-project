...
module {
  llvm.func @printf(!ptr.ptr, ...) -> i32
  llvm.mlir.global internal constant @str0("WG size of kernel = %d X %d\0A\00")

  llvm.func @main(%arg0: i32, %arg1: !ptr.ptr) -> i32 {
    omp.parallel   {
      %0 = llvm.mlir.constant(1 : index) : i64
      %1 = llvm.mlir.constant(10 : index) : i64
      %2 = llvm.mlir.constant(0 : index) : i64
      %4 = llvm.mlir.constant(0 : i32) : i32
      %12 = llvm.alloca %0 x i64 : (i64) -> !ptr.ptr
      omp.wsloop for (%arg2) : i64 = (%2) to (%1) step (%0)  {
        omp.parallel   {
          omp.wsloop for (%arg3) : i64 = (%2) to (%0) step (%0)  {
            llvm.store %2, %12 : i64, !ptr.ptr
            omp.yield
          }
          omp.terminator
        }
        %19 = llvm.load %12 : !ptr.ptr -> i64
        %20 = llvm.trunc %19 : i64 to i32
        %5 = llvm.mlir.addressof @str0 : !ptr.ptr
        %6 = llvm.getelementptr %5[%4, %4] : (!ptr.ptr, i32, i32) -> !ptr.ptr, !llvm.array<29 x i8>
        %21 = llvm.call @printf(%6, %20, %20) vararg(!llvm.func<i32 (ptr, ...)>): (!ptr.ptr, i32, i32) -> i32
        omp.yield
      }
      omp.terminator
    }
