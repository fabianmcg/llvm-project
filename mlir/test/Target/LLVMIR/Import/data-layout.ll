...
; CHECK-DAG:   #dlti.dl_entry<!ptr.ptr, dense<64> : vector<4xi32>>
...
; CHECK-DAG:   #dlti.dl_entry<i8, dense<8> : vector<2xi32>>
; CHECK-DAG:   #dlti.dl_entry<!ptr.ptr<270>, dense<[32, 64, 64, 32]> : vector<4xi32>>
; CHECK-DAG:   #dlti.dl_entry<!ptr.ptr<271>, dense<32> : vector<4xi32>>
; CHECK-DAG:   #dlti.dl_entry<!ptr.ptr<272>, dense<64> : vector<4xi32>>
...
; CHECK-DAG:   #dlti.dl_entry<!ptr.ptr<270>, dense<[16, 32, 64, 8]> : vector<4xi32>>
; CHECK-DAG:   #dlti.dl_entry<!ptr.ptr<271>, dense<[16, 32, 64, 16]> : vector<4xi32>>
