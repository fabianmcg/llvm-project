...
llvm.func @testenterdataop(%arg0: !ptr.ptr, %arg1 : !ptr.ptr) {
  %0 = acc.create varPtr(%arg0 : !ptr.ptr) -> !ptr.ptr
  %1 = acc.copyin varPtr(%arg1 : !ptr.ptr) -> !ptr.ptr
  acc.enter_data dataOperands(%0, %1 : !ptr.ptr, !ptr.ptr)
  llvm.return
}
...
llvm.func @testexitdataop(%arg0: !ptr.ptr, %arg1: !ptr.ptr) {
  %arg0_devptr = acc.getdeviceptr varPtr(%arg0 : !ptr.ptr) -> !ptr.ptr
  %1 = acc.getdeviceptr varPtr(%arg1 : !ptr.ptr) -> !ptr.ptr
  acc.exit_data dataOperands(%arg0_devptr, %1 : !ptr.ptr, !ptr.ptr)
  acc.delete accPtr(%arg0_devptr : !ptr.ptr)
  acc.copyout accPtr(%1 : !ptr.ptr) to varPtr(%arg1 : !ptr.ptr)
  llvm.return
}
...
llvm.func @testupdateop(%arg1: !ptr.ptr) {
  %0 = acc.update_device varPtr(%arg1 : !ptr.ptr) -> !ptr.ptr
  acc.update dataOperands(%0 : !ptr.ptr)
  llvm.return
}
...
llvm.func @testdataop(%arg0: !ptr.ptr, %arg1: !ptr.ptr, %arg2: !ptr.ptr) {
  
  %0 = acc.copyin varPtr(%arg0 : !ptr.ptr) -> !ptr.ptr
  %1 = acc.create varPtr(%arg1 : !ptr.ptr) -> !ptr.ptr
  acc.data dataOperands(%0, %1 : !ptr.ptr, !ptr.ptr) {
    %9 = llvm.mlir.constant(2 : i32) : i32
    llvm.store %9, %arg2 : i32, !ptr.ptr
    acc.terminator
  }
  acc.copyout accPtr(%0 : !ptr.ptr) to varPtr(%arg0 : !ptr.ptr)
  acc.copyout accPtr(%1 : !ptr.ptr) to varPtr(%arg1 : !ptr.ptr)
  llvm.return
}
