...
module attributes {omp.is_target_device = true} {
  ...
  llvm.func @_QQmain() attributes {} {
    %0 = llvm.mlir.addressof @_QMtest_0Esp : !ptr.ptr
  ...
  // CHECK-DAG: br label %omp.region.cont
    %map = omp.map_info var_ptr(%0 : !ptr.ptr, i32)   map_clauses(tofrom) capture(ByRef) -> !ptr.ptr {name = ""}
    omp.target   map_entries(%map -> %arg0 : !ptr.ptr) {
      ^bb0(%arg0: !ptr.ptr):
