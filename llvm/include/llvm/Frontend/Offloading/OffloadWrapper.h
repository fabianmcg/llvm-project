...
#ifndef LLVM_FRONTEND_OFFLOADING_UTILITY_OFFLOAD_WRAPPER_H
#define LLVM_FRONTEND_OFFLOADING_UTILITY_OFFLOAD_WRAPPER_H
...
#endif // LLVM_FRONTEND_OFFLOADING_UTILITY_OFFLOAD_WRAPPER_H
